<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $connectionDB->updateData($Tables[1],$Data_conmorbilidades,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[2],$Data_atencion_medica,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[3],$Data_pre_hierro,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[4],$Data_reacciones_previas,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[5],$Data_procedimiento_qx,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[6],$Data_post_hierro,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[7],$Data_reacciones_previas,$updateColum,$updateId);
