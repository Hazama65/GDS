...
<head>
    ...
    <style>
        ...
        .badge {
            ...
            padding: 10px;
            margin-bottom: 10px;
            background-color: rgb(49, 129, 110,0.5); /* Color de fondo */
            color: white;
            font-size: 20px;
            }
...
<body>
    ...
    <div class="container">
        <div class="graficas" id="chartdiv1">
            <span class="badge">Sexos</span>
        </div>
        <div class="graficas" id="chartdiv2">
            <span class="badge">Resultado IMC</span>
        </div>
    </div>
