...
<body>
    ...
    <div class="form-header">
        ...
        <h5 class="form-title" style="text-align: center;
                        ...
                        margin-top:35;
                        font-size: 30px;">
            ¿El Médico y  la Enfermera  le explicaron fácilmente sobre su enfermedad  y  sus cuidados? </h5>
    </div>
    ...
    <div class="container">
        <div class="cards-list">
            ...
            <div class="card-trato card trato card-1" onclick="document.getElementById('info_Si').checked = true;">
                <div class="card_image">
                    <img src="img/muysatisfecho.png" />
                </div>
                <div class="card_title">
                    <input type="radio" id="info_Si" name="grupo_info" value="info_Si"><br><br>
                    <label style="color: black; font-size: 12px;" for="info_Si">Satisfecho</label>
                </div>
            </div>

            <div class="card-trato card trato card-1" onclick="document.getElementById('info_regular').checked = true;">
                <div class="card_image">
                    <img src="img/regular.png" />
                </div>
                <div class="card_title">
                    <input type="radio" id="info_regular" name="grupo_info" value="info_regular"><br><br>
                    <label style="color: black; font-size: 12px;" for="info_regular">Regular</label>
                </div>
            </div>
            ...
            <div class="card-trato card trato card-1" onclick="document.getElementById('info_Si').checked = true;">
                ...
                <div class="card_title">
                    <input type="radio" id="info_Si" name="grupo_info" value="info_Si"><br><br>
                    <label style="color: black; font-size: 12px;" for="info_Si">Insatisfecho</label>
                </div>
            </div>
