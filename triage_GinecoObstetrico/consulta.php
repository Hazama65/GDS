    ...
    <div class="container" style="padding: 5px;">
        ...
        <form action="php/controllers/generar_pdf.controller.php" method="POST" target="_blank">
            <div class="btn-group d-flex justify-content-end" role="group" aria-label="Basic example">
                <input type="hidden" name="valor" value="<?php echo $id_GN; ?>">
        ...
        <thead>
            <tr>
                <th colspan="2" scope="col"
                    style="background-color: rgb(225, 63, 164); color: aliceblue; text-align: center;">
                    <i class="bi bi-person-circle"></i> Generales
                </th>
        ...
        <tbody>
            ...
            <tr>
                <th colspan="2" scope="row"
                    style="background-color: rgb(174,93,143,0.75); color: aliceblue; text-align: center;">Datos Paciente
                </th>
            </tr>
            ...
            <tr>
                <th colspan="2" scope="row"
                    style="background-color: rgb(174,93,143,0.75); color: aliceblue; text-align: center;">Antecedentes
                    Gineco-Obstétricos</th>
            </tr>
            ...
            <tr>
                <th colspan="2" scope="row"
                    style="background-color: rgb(174,93,143,0.75); color: aliceblue; text-align: center;">Signos Vitales
                </th>
            </tr>
            ...
            <tr>
                <th colspan="2" scope="row"
                    style="background-color: rgb(174,93,143,0.75); color: aliceblue; text-align: center;">Síntomas</th>
            </tr>
            ...
            <tr>
                <th colspan="2" scope="row"
                    style="background-color: rgb(174,93,143,0.75); color: aliceblue; text-align: center;">Signos</th>
            </tr>
            ...
            <tr>
                <th colspan="2" scope="row"
                    style="background-color: rgb(174,93,143,0.75); color: aliceblue; text-align: center;">Tira Reactiva
                    en Orina</th>
            </tr>
            ...
            <tr>
                <th colspan="2" scope="row"
                    style="background-color: rgb(174,93,143,0.75); color: aliceblue; text-align: center;">Transferir
                </th>
            </tr>
            <tr>
