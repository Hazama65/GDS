                ...
                <form id="SC_form" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" id="idnombre">
                            ...
                            <input id="nombre" name="nombre" onblur="calcularEdad();" type="text" class="control form-control" style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="edad" name="edad" type="text" class="control form-control" style="font-size: 13px;" readonly>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="Poblacion_indigena" name="Poblacion_indigena" type="text" class="control form-control" style="font-size: 13px;">
                        </div>
    
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Raza</strong>
                            <input id="Raza" name="Raza" type="text" class="control form-control" style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input list="Clues" name="unidad_referencia" id="unidad_referencia" class="control form-control" style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="FC" name="FC" type="number" class="control form-control" style="font-size: 13px;">
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Tabaquismo</span>
                        ...
                        <div class="col-md-3">
                            ...
                            <input list="enfermedades" value="Ninguno" name="Padre_antecedente" id="Padre_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Madre</strong>
                            <input list="enfermedades" value="Ninguno" name="Madre_antecedente" id="Madre_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Abuelo Materno</strong>
                            <input list="enfermedades" value="Ninguno" name="Abuelo_Materno_antecedente" id="Abuelo_Materno_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Abuelo Paterno</strong>
                            <input list="enfermedades" value="Ninguno" name="Abuelo_Paterno_antecedente" id="Abuelo_Paterno_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Abuela Materna</strong>
                            <input list="enfermedades" value="Ninguno" name="Abuela_Materna_antecedente" id="Abuela_Materna_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Abuela Paterna</strong>
                            <input list="enfermedades" value="Ninguno" name="Abuela_Paterna_antecedente" id="Abuela_Paterna_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Hermano</strong>
                            <input list="enfermedades" value="Ninguno" name="Hermano_antecedente" id="Hermano_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Hermana</strong>
                            <input list="enfermedades" value="Ninguno" name="Hermana_antecedente" id="Hermana_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Prima Materna</strong>
                            <input list="enfermedades" value="Ninguno" name="Prima_Materna_antecedente" id="Prima_Materna_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Prima Paterna</strong>
                            <input list="enfermedades" value="Ninguno" name="Prima_Paterna_antecedente" id="Prima_Paterna_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Primo Paterno</strong>
                            <input list="enfermedades" value="Ninguno" name="Primo_Paterno_antecedente" id="Primo_Paterno_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Primo Materno</strong>
                            <input list="enfermedades" value="Ninguno" name="Primo_Materno_antecedente" id="Primo_Materno_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Tía Materna</strong>
                            <input list="enfermedades" value="Ninguno" name="Tia_Materna_antecedente" id="Tia_Materna_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Tía Paterna</strong>
                            <input list="enfermedades" value="Ninguno" name="Tia_Paterna_antecedente" id="Tia_Paterna_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Tío Materno</strong>
                            <input list="enfermedades" value="Ninguno" name="Tia_Materno_antecedente" id="Tia_Materno_antecedente" class="control form-control" style="font-size: 13px;">
                            
                        </div>
    
                        <div class="col-md-3">
                            <strong style="font-size: 13px;">Tío Paterno</strong>
                            <input list="enfermedades" value="Ninguno" name="Tia_Paterno_antecedente" id="Tia_Paterno_antecedente" class="control form-control" style="font-size: 13px;">
                        ...
                        <div class="container" id="Cara_tipicas"style="display:none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="text-align: center;">
                                    ...
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Dolor_Retroesternal" id="Dolor_Retroesternal" value="Dolor Retroesternal" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Opresivo</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Opresivo" id="Opresivo" value="Opresivo" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Irradiación brazo izquierdo</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Irradiación_brazo_izquierdo" id="Irradiación_brazo_izquierdo" value="Irradiación brazo izquierdo" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Más de 10 minutos</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Más_de_10_minutos" id="Más_de_10_minutos" value="Más de 10 minutos" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Náuseas</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Náuseas" id="Náuseas" value="Náuseas" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Diaforesis</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Diaforesis_1" id="Diaforesis_1" value="Diaforesis" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Síncope</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Síncope_2" id="Síncope_2" value="Síncope" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                        ...
                        <div class="container" id="Cara_Atipicas" style="display:none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="text-align: center;">
                                    ...
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Dolor_Epigastrio" id="Dolor_Epigastrio" value="Dolor Epigastrio" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Punzante</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Punzante" id="Punzante" value="Punzante" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Pleurítico</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Pleurítico" id="Pleurítico" value="Pleurítico" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Disnea</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Disnea" id="Disnea" value="Disnea" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Palpitación</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Palpitación" id="Palpitación" value="Palpitación" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Diaforesis</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Diaforesis_2" id="Diaforesis_2" value="Diaforesis" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
    
                                <div class="col-md-3" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Síncope</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Síncope_1" id="Síncope_1" value="Síncope" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="control form-control" id="ck_mb" name="ck_mb" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Troponinas</strong>
                            <input type="text" class="control form-control" id="Troponinas" name="Troponinas" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Glucosa</strong>
                            <input type="text" class="control form-control" id="Glucosa" name="Glucosa" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Urea</strong>
                            <input type="text" class="control form-control" id="Urea" name="Urea" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Creatinina</strong>
                            <input type="text" class="control form-control" id="Creatinina" name="Creatinina" sytle="font-size: 13px;">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Colesterol</strong>
                            <input type="text" class="control form-control" id="Colesterol" name="Colesterol" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Trigliceridos</strong>
                            <input type="text" class="control form-control" id="Trigliceridos" name="Trigliceridos" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Ácido Úrico</strong>
                            <input type="text" class="control form-control" id="Acido_Urico" name="Acido_Urico" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">HB Glucosilada</strong>
                            <input type="text" class="control form-control" id="hb_glucosilada" name="hb_glucosilada" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Proteínas</strong>
                            <input type="text" class="control form-control" id="Proteinas" name="Proteinas" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">LDL</strong>
                            <input type="text" class="control form-control" id="LDL" name="LDL" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">HDL</strong>
                            <input type="text" class="control form-control" id="HDL" name="HDL" sytle="font-size: 13px;">
                        </div>
                        ...
                        <div class="container" id="Si_lesionCoronaria" style="display:none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" style="text-align: center;">
                                    ...
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Coronaria_Derecha" id="Coronaria_Derecha" value="Coronaria Derecha" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Coronaria Izquierda</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Coronaria_Izquierda" id="Coronaria_Izquierda" value="Coronaria Izquierda" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Descendente Anterior</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Descendente_Anterior" id="Descendente_Anterior" value="Descendente Anterior" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Descendente Posterior</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Descendente_Posterior" id="Descendente_Posterior" value="Descendente Posterior" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Tronco Coronario Izquierdo</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Tronco_Coronario_Izquierdo" id="Tronco_Coronario_Izquierdo" value="Tronco Coronario Izquierdo" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Bifurcación</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Bifurcacion" id="Bifurcacion" value="Bifurcación" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Circunfleja</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Circunfleja" id="Circunfleja" value="Circunfleja" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Dominancia Derecha</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Dominancia_Derecha" id="Dominancia_Derecha" value="Dominancia Derecha" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Codominancia</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Codominancia" id="Codominancia" value="Codominancia" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Dominancia Izquierda</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Dominancia_Izquierda" id="Dominancia_Izquierda" value="Dominancia Izquierda" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Ramo Posterolateral</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Ramo_Posterolateral" id="Ramo_Posterolateral" value="Ramo Posterolateral" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Ramo Septales</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Ramo_Septales" id="Ramo_Septales" value="Ramo Septales" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                                <div class="col-md-4" style="text-align: center;">
                                    <span style="font-size:13px; display: block;">Ramo Marginales</span>
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Ramo_Marginales" id="Ramo_Marginales" value="Ramo Marginales" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
