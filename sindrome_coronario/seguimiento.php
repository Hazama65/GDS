        ...
        <form id="seguimiento_SC" method="POST">
            ...
            <div class="form-header">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="control form-control" id="Seguimiento_ck" name="Seguimiento_ck" style="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">CK-MB</strong>
                            <input type="text" class="control form-control" id="Seguimiento_ck_mb" name="Seguimiento_ck_mb" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Troponinas</strong>
                            <input type="text" class="control form-control" id="Seguimiento_Troponinas" name="Seguimiento_Troponinas" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Glucosa</strong>
                            <input type="text" class="control form-control" id="Seguimiento_Glucosa" name="Seguimiento_Glucosa" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Urea</strong>
                            <input type="text" class="control form-control" id="Seguimiento_Urea" name="Seguimiento_Urea" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Creatinina</strong>
                            <input type="text" class="control form-control" id="Seguimiento_Creatinina" name="Seguimiento_Creatinina" sytle="font-size: 13px;">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Colesterol</strong>
                            <input type="text" class="control form-control" id="Seguimiento_Colesterol" name="Seguimiento_Colesterol" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Trigliceridos</strong>
                            <input type="text" class="control form-control" id="Seguimiento_Trigliceridos" name="Seguimiento_Trigliceridos" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Ácido Úrico</strong>
                            <input type="text" class="control form-control" id="Seguimiento_Acido_Urico" name="Seguimiento_Acido_Urico" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">HB Glucosilada</strong>
                            <input type="text" class="control form-control" id="Seguimiento_hb_glucosilada" name="Seguimiento_hb_glucosilada" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">Proteínas</strong>
                            <input type="text" class="control form-control" id="Seguimiento_Proteinas" name="Seguimiento_Proteinas" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">LDL</strong>
                            <input type="text" class="control form-control" id="Seguimiento_LDL" name="Seguimiento_LDL" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-2">
                            <strong style="font-size: 13px">HDL</strong>
                            <input type="text" class="control form-control" id="Seguimiento_HDL" name="Seguimiento_HDL" sytle="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-6" id="Seg_resultado_gamma" style="display:none;">
                            ...
                            <div class="col-md-6" id="Seg_positivo_1" style="display:none;">
                                ...
                                <select name="Seg_Localizacion_gamma" id="Seg_Localizacion_gamma" class="form-select" style="font-size: 13px;">
                                    <option value="Seleccione">Seleccione</option>
                            ...
                            <div class="col-md-6"  id="Seg_positivo_2" style="display:none;">
                                ...
                                <select name="Seg_Segmento_gamma" id="Seg_Segmento_gamma" class="form-select" style="font-size: 13px;">
                                    <option value="Seleccione">Seleccione</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="Seg_Resonancia_inicial" id="Seg_Resonancia_inicial" class="form-select" style="font-size: 13px;">
                                <option value="Seleccione">Seleccione</option>
                                <option value="Si">Si</option>
                                <option value="No">No</option>
                            </select>
                            ...
                            <div class="col-md-6" id="Seg_resonancia_resu" style="display:none;">
                                ...
                                <select name="Seg_resultado_resonancia" id="Seg_resultado_resonancia" class="form-select" style="font-size: 13px;">
                                    <option value="Seleccione">Seleccione</option>
                                    <option value="Positivo">Positivo</option>
                                    <option value="Negativo">Negativo</option>
                                </select>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="Seg_Suspension_estudio" id="Seg_Suspension_estudio" class="form-select" style="font-size: 13px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="control form-control" id="Seg_Distolico_inicial" name="Seg_Distolico_inicial" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-4">
                            <strong style="font-size: 13px">Sistolico Inicial</strong>
                            <input type="text" class="control form-control" id="Seg_Sistolico_inicial" name="Seg_Sistolico_inicial" sytle="font-size: 13px;">
                        </div>
    
                        <div class="col-md-4">
                            <strong style="font-size: 13px;">Frac. Eyección Ventrículo Izq Inicial</strong>
                            <select name="Seg_eyeccion_ventriizqui" id="Seg_eyeccion_ventriizqui" class="form-select" style="font-size: 13px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="Seg_movilidad_inicial" id="Seg_movilidad_inicial" class="form-select" style="font-size: 13px;">
                                <option value="Seleccione">Seleccione</option>
