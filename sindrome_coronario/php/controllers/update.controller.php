<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $connectionDB->updateData($Tables[1],$Data_factor_riesgo,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[2],$Data_antecedentes_familiares,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[3],$Data_atencion_clinica,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[4],$Data_paraclinicos,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[5],$Data_tratamiento,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[6],$Data_lesion_coronaria,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[7],$Data_tratamiento_esp,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[8],$Data_viabilidad,$updateColum,$updateId);
        ...
        $connectionDB->updateData($Tables[9],$Data_eco_defuncion,$updateColum,$updateId);
