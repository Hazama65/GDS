                ...
                <div class="modal-body">
                    ...
                    <div class="row"> <!-- DATOS GENERALES  -->
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="nombre_paciente" name="nombre_paciente" type="text" class="control form-control"
                                placeholder="Nombre(s) Apellidos" style="font-size:14px;">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="residencia" name="residencia" type="text" class="control form-control"
                                style="font-size:14px;">
                        </div>

                        <div class="col-md-6">
                            <strong style="font-size:14px;">Nivel Socioeconomico</strong>
                            <select name="Nivel_socioeconomico" id="Nivel_socioeconomico" class="form-control"
                                style="font-size:14px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="contacto_personas" id="contacto_personas" class="form-control"
                                onchange="mostrarOcultarSecciones()" style="font-size: 14px;">
                        ...
                        <div class="col-md-12" id="ah_TosCronica" style="display: none;">
                            ...
                            <select name="TosCronicaSelect" id="TosCronicaSelect" class="form-control"
                                style="font-size: 14px;">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="container" id="heredo_familia1" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" id="MadreTos">
                                    ...
                                    <select name="Tos_Madre" id="Tos_Madre" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuelo_MaternoTos">
                                    ...
                                    <select name="TosAbueloMaterno" id="TosAbueloMaterno" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuela_MaternaTos">
                                    ...
                                    <select name="TosAbuelaMaterna" id="TosAbuelaMaterna" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuelo_PaternoTos">
                                    ...
                                    <select name="TosAbueloPaterno" id="TosAbueloPaterno" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuela_PaternaTos">
                                    ...
                                    <select name="TosAbuelaPaterna" id="TosAbuelaPaterna" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="HermanaTos">
                                    ...
                                    <input type="number" step="any" class="form-control" id="Tos_hermanas"
                                        name="Tos_hermanas" style="font-size: 14px;">
                                </div>
                                <!--===============sI SELECCIONAMOS HERMANO =======================-->

                                <div class="col-md-4" id="HermanoTos">
                                    <span style="font-size: 14px;">Número de Hermanos</span>
                                    <input type="number" step="any" class="form-control" id="Tos_hermanos"
                                        name="Tos_hermanos">
                                </div>
                        ...
                        <div class="col-md-12" id="ah_Tuberculosis" style="display: none;">
                            ...
                            <select name="TuberculosisSelect" id="TuberculosisSelect" class="form-control"
                                style="font-size: 14px;">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="container" id="heredo_familia2" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" id="PadreTuber">
                                    <span style="font-size: 14px;">Padre</span>
                                    <select name="TuberPadre" id="TuberPadre" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="MadreTuber">
                                    <span style="font-size: 14px;">Madre</span>
                                    <select name="TuberMadre" id="TuberMadre" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuelo_MaternoTuber">
                                    <span style="font-size: 14px;">Abuelo Materno</span>
                                    <select name="TuberAbueloMaterno" id="TuberAbueloMaterno" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuela_MaternaTuber">
                                    <span style="font-size: 14px;">Abuela Materna</span>
                                    <select name="TuberAbuelaMaterna" id="TuberAbuelaMaterna" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuelo_PaternoTuber">
                                    <span style="font-size: 14px;">Abuelo Paterno</span>
                                    <select name="TuberAbueloPaterno" id="TuberAbueloPaterno" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuela_PaternaTuber">
                                    <span style="font-size: 14px;">Abuela Paterna</span>
                                    <select name="TuberAbuelaPaterna" id="TuberAbuelaPaterna" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="HermanaTuber">
                                    <span style="font-size: 14px;">Número de Hermanas</span>
                                    <input type="number" step="any" class="form-control" id="Tuber_hermanas"
                                        name="Tuber_hermanas" style="font-size: 14px;">
                                </div>
                                <!--===============sI SELECCIONAMOS HERMANO TUBERCULOSIS =======================-->

                                <div class="col-md-4" id="HermanoTuber">
                                    <span style="font-size: 14px;">Número de Hermanos</span>
                                    <input type="number" step="any" class="form-control" id="Tuber_hermanos"
                                        name="Tuber_hermanos" style="font-size: 14px;">
                                </div>
                        ...
                        <div class="container" id="heredo_familia3" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" id="Abuelo_MaternoVIH">
                                    <span style="font-size: 14px;">Abuelo Materno</span>
                                    <select name="VIHAbueloMaterno" id="VIHAbueloMaterno" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuela_MaternaVIH">
                                    <span style="font-size: 14px;">Abuela Materna</span>
                                    <select name="VIHAbuelaMaterna" id="VIHAbuelaMaterna" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuelo_PaternoVIH">
                                    <span style="font-size: 14px;">Abuelo Paterno</span>
                                    <select name="VIHAbueloPaterno" id="VIHAbueloPaterno" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="Abuela_PaternaVIH">
                                    <span style="font-size: 14px;">Abuela Paterna</span>
                                    <select name="VIHAbuelaPaterna" id="VIHAbuelaPaterna" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Negado">Negado</option>
                                        <option value="Si">Si</option>
                                    </select>
                                ...
                                <div class="col-md-4" id="HermanaVIH">
                                    <span style="font-size: 14px;">Número de Hermanas</span>
                                    <input type="number" step="any" class="form-control" id="VIH_hermanas"
                                        name="VIH_hermanas" style="font-size: 14px;">
                                </div>
                                <!--===============sI SELECCIONAMOS HERMANO VIH=======================-->

                                <div class="col-md-4" id="HermanoVIH">
                                    <span style="font-size: 14px;">Número de Hermanos</span>
                                    <input type="number" step="any" class="form-control" id="VIH_hermanos"
                                        name="VIH_hermanos" style="font-size: 14px;">
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="contacto_animales" id="contacto_animales" class="form-control"
                                style="font-size:14px;">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="col-md-6" id="tipo_alimentarios" style="display: none;">
                            ...
                            <select name="tipoalimentos" id="tipoalimentos" class="form-control"
                                style="font-size:14px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                ...
                                                <label style="font-size: 14px;" class="custom-control-label"
                                                    for="bcg_NC">BCG</label>
                                                <br>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="hepatitis_nacimiento" id="hepatitis_nacimiento">
                                                <label class="custom-control-label" for="hepatitis_RC"
                                                    style="font-size:14px;">Hepatitis B</label>
                                                <br>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="pentavalente_2mes" id="pentavalente_2mes">
                                                <label class="custom-control-label" for="pentavalente2"
                                                    style="font-size:14px;">Pentavalente Acelular</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="hepatitisB_2mes" id="hepatitisB_2mes">
                                                <label class="custom-control-label" for="hepatitis_2B"
                                                    style="font-size:14px;">Hepatitis B</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="rotavirus_2mes" id="rotavirus_2mes">
                                                <label class="custom-control-label" for="rotavirus_2"
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="neumococo_2mes" id="neumococo_2mes">
                                                <label class="custom-control-label" for="neumococo_c2"
                                                    style="font-size:14px;">Neumococo</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="pentavalente_4mes" id="pentavalente_4mes">
                                                <label class="custom-control-label" for="pentavalente_acelular_4"
                                                    style="font-size:14px;">Pentavalente Acelular</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="rotavirus_4mes" id="rotavirus_4mes">
                                                <label class="custom-control-label" for="rotavirus_4"
                                                    style="font-size:14px;">Rotavirus</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="neumococo_4mes" id="neumococo_4mes">
                                                <label class="custom-control-label" for="neumococo_4c"
                                                    style="font-size:14px;">Neumococo C.</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="pentavalente_6mes" id="pentavalente_6mes">
                                                <label class="custom-control-label" for="pentavalente_6"
                                                    style="font-size:14px;">Pentavalente Acelular</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="Influenza_6mes" id="Influenza_6mes">
                                                <label class="custom-control-label" for="Influenza_6"
                                                    style="font-size:14px;">Influenza</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="Influenza_7mes" id="Influenza_7mes">
                                                <label class="custom-control-label" for="Influenza_2da"
                                                    style="font-size:14px;">Influenza 2da dosis</label>
                                            </div>
                                        </td>
                                    ...
                                    <td>
                                        <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                            <input type="checkbox" class="custom-control-input" name="SRP_12mes"
                                                id="SRP_12mes">
                                            <label class="custom-control-label" for="SRP_12"
                                                style="font-size:14px;">SRP</label>
                                        </div>
                                    </td>

                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="neumococo_12mes"
                                                id="neumococo_12mes" style="font-size:13px;">
                                            <label class="custom-control-label" for="neumococo_c12"
                                                style="font-size:14px;">Neumococo C.</label>
                                        </div>
                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="Pentavaleente_18mes" id="Pentavaleente_18mes">
                                                <label class="custom-control-label" for="Pentavalente_Acelular_18"
                                                    style="font-size:14px;">Pentavalente Acelular</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="influenza_refuerzo_24mes" id="influenza_refuerzo_24mes">
                                                <label class="custom-control-label" for="influenza_R24"
                                                    style="font-size:14px;">Influenza Refuerzo Anual</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="influenza_refuerzo_36mes" id="influenza_refuerzo_36mes">
                                                <label class="custom-control-label" for="influenza_R36"
                                                    style="font-size:14px;">Influenza Refuerzo Anual</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="DPTrefuerzo_48mes" id="DPTrefuerzo_48mes">
                                                <label class="custom-control-label" for="DPT_R48"
                                                    style="font-size:14px;">DPT(Refuerzo)</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input"
                                                    name="Influenza_R48mes" id="Influenza_R48mes">
                                                <label class="custom-control-label" for="Influenza_RA48"
                                                    style="font-size:14px;">Influenza Refuerzo Anual</label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input" name="Influenza_R59"
                                                    id="Influenza_R59">
                                                <label class="custom-control-label" for="Influenza_enero"
                                                    style="font-size:14px;">Influenza Refuerzo Anual</label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input" name="OVP59"
                                                    id="OVP59">
                                                <label class="custom-control-label" for="OVP"
                                                    style="font-size:14px;">OVP</label>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                                <input type="checkbox" class="custom-control-input" name="srp_refuerzo"
                                                    id="srp_refuerzo">
                                                <label class="custom-control-label" for="SRP_ref"
                                                    style="font-size:14px;">SRP (Refuerzo)</label>
                                            </div>
                                        </td>
                                    ...
                                    <td>
                                        <div class="custom-control custom-checkbox" style="white-space: nowrap;">
                                            <input type="checkbox" class="custom-control-input" name="VPH_11"
                                                id="VVPH_11PH">
                                            <label class="custom-control-label" for="VPH"
                                                style="font-size:14px;">VPH</label>
                                        </div>
                                    </td>
                    ...
                    <div class="row"> <!--===========ROW DE ANTECEDENTES PATOLOGICOS ================-->
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="Neuropatia_croninca" id="Neuropatia_croninca" class="form-control"
                                style="font-size:14px">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="col-md-3" id="edad_neumo" style="display: none;">
                            ...
                            <input type="number" step="any" class="form-control" id="neumo_edad" name="neumo_edad"
                                style="font-size: 14px;">
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="Discapacidad_intelectual" id="Discapacidad_intelectual" class="form-control"
                                style="font-size:14px;">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="pancreatitis_avp" id="pancreatitis_avp" class="form-control"
                                style="font-size:14px;">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="apendicectomia" id="apendicectomia" class="form-control"
                                style="font-size: 14px">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="rinitis_alergica" id="rinitis_alergica" class="form-control"
                                style="font-size:14px;">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="Pielonefritis" id="Pielonefritis" class="form-control"
                                style="font-size:14px;">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="col-md-3" id="edad_varicela" style="display: none;">
                            ...
                            <input type="number" step="any" class="form-control" id="varicela_edad" name="varicela_edad"
                                style="font-size: 14px;">
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" id="tiempo_evolucion">
                            ...
                            <input type="number" step="any" class="form-control" id="evolucion_ganglio"
                                name="evolucion_ganglio" style="font-size: 14px;">
                            </select>
                        </div>

                        <div class="col-md-4">
                            <strong style="font-size:14px;">Período Evolución</strong>
                            <select name="evolucion_periodo" id="evolucion_periodo" class="form-control"
                                style="font-size:14px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        <div class="col-md-4" id="tamaño_ganglio">
                            ...
                            <input type="number" step="any" class="form-control" id="Ganglio_tama"
                                name="Ganglio_tama" style="font-size: 14px;">
                            </select>
                        </div>
                    ...
                    <div class="container text-center">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="checkbox" name="No_doloroso" id="No_doloroso" value="Si"
                                    style="font-size:14px;">
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="checkbox" name="Indurado" id="Indurado" value="Si" style="font-size:14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px">No Indurado</span>
                                <input type="checkbox" name="No_Indurado" id="No_Indurado" value="Si"
                                    style="font-size:14px;">
                            </div>
                        </div><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="checkbox" name="Eritematoso" id="Eritematoso" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Hipertermico</span>
                                <input type="checkbox" name="Hipertermico" id="Hipertermico" value="Si"
                                    style="font-size: 14px;">
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="checkbox" name="con_Secrecion" id="con_Secrecion" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Sin Secreción</span>
                                <input type="checkbox" name="sin_secrecion" id="sin_secrecion" value="Si"
                                    style="font-size: 14px;">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="checkbox" name="bien_delimitado" id="bien_delimitado" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Mal Delimitado</span>
                                <input type="checkbox" name="mal_delimitado" id="mal_delimitado" value="Si"
                                    style="font-size: 14px;">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="checkbox" name="Fijo" id="Fijo" value="Si" style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">Movíl</span>
                                <input type="checkbox" name="Movil" id="Movil" value="Si" style="font-size: 14px;">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="checkbox" name="cambios_coloracion" id="cambios_coloracion" value="Si"
                                    style="font-size: 14px;">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="checkbox" name="sin_cambios" id="sin_cambios" value="Si"
                                    style="font-size:14px;">
                            </div>
                    ...
                    <div class="container text-center" id="otro_localizacion" style="display: none;">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="checkbox" name="local_submandibulares" id="local_submandibulares"
                                    value="Si" style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Axilares</span>
                                <input type="checkbox" name="local_axilares" id="local_axilares" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Inguinales</span>
                                <input type="checkbox" name="local_inguinales" id="local_inguinales" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Cervicales</span>
                                <input type="checkbox" name="local_cervicales" id="local_cervicales" value="Si"
                                    style="font-size: 14px;">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="checkbox" name="local_retroauri" id="local_retroauri" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Subclavicular</span>
                                <input type="checkbox" name="local_subclav" id="local_subclav" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Occipital</span>
                                <input type="checkbox" name="local_occipital" id="local_occipital" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Adenopatias</span>
                                <input type="checkbox" name="local_adeno" id="local_adeno" value="Si"
                                    style="font-size: 14px;">
                            </div>
                    ...
                    <div class="container text-center" id="etiologia">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="checkbox" name="etiologia_VEB" id="etiologia_VEB" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">CMV</span>
                                <input type="checkbox" name="etiologia_CMV" id="etiologia_CMV" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-1">
                                <span style="font-size: 14px;">TB</span>
                                <input type="checkbox" name="etiologia_TB" id="etiologia_TB" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">B19</span>
                                <input type="checkbox" name="etiologia_B19" id="etiologia_B19" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">Bocio</span>
                                <input type="checkbox" name="etiologia_bocio" id="etiologia_bocio" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-3">
                                <span style="font-size: 14px;">Rubéola</span>
                                <input type="checkbox" name="etiologia_rubeola" id="etiologia_rubeola" value="Si"
                                    style="font-size: 14px;">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="checkbox" name="etiologia_bartonella" id="etiologia_bartonella" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">Toxoplamosis</span>
                                <input type="checkbox" name="etiologia_toxoplamosis" id="etiologia_toxoplamosis"
                                    value="Si" style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">Inflamatorio</span>
                                <input type="checkbox" name="etioligia_inflamatorio" id="etioligia_inflamatorio"
                                    value="Si" style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">Parvovirus</span>
                                <input type="checkbox" name="etiologia_parvovirus" id="etiologia_parvovirus" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">Varicela</span>
                                <input type="checkbox" name="etiologia_varicela" id="etiologia_varicela" value="Si"
                                    style="font-size: 14px;">
                            </div>
                ...
                margin-top: 15px;">
                    ...
                    <div class="container text-center" id="tx_fx" style="display: none;">
                        ...
                        <div class="row ">
                            <div class="col-md-2">
                                ...
                                <input type="checkbox" name="tx_Isonicida" id="tx_Isonicida" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">Rifampicina</span>
                                <input type="checkbox" name="tx_Rifampicina" id="tx_Rifampicina" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">Pirazinamida</span>
                                <input type="checkbox" name="tx_Pirazinamida" id="tx_Pirazinamida" value="Si"
                                    style="font-size: 14px;">
                            </div>

                            <div class="col-md-2">
                                <span style="font-size: 14px;">Etambutol</span>
                                <input type="checkbox" name="tx_Etambutol" id="tx_Etambutol" value="Si"
                                    style="font-size: 14px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="number" step="any" class="form-control" id="id_Hemoglobina"
                                name="id_Hemoglobina">
                        </div>

                        <div class="col-md-3">
                            <strong style="font-size: 14px;">Hematocrito</strong>
                            <input type="number" step="any" class="form-control" id="id_Hematocrito"
                                name="id_Hematocrito">
                        </div>

                        <div class="col-md-3">
                            <strong style="font-size: 14px;">Leucocitos</strong>
                            <input type="number" step="any" class="form-control" id="id_Leucocitos"
                                name="id_Leucocitos">
                        </div>

                        <div class="col-md-3">
                            <strong style="font-size: 14px;">Neutrófilos</strong>
                            <input type="number" step="any" class="form-control" id="id_Neutrfilos"
                                name="id_Neutrfilos">
                        </div>

                        <div class="col-md-3">
                            <strong style="font-size: 14px;">Linfocitos</strong>
                            <input type="number" step="any" class="form-control" id="id_Linfocitos"
                                name="id_Linfocitos">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step="any" class="form-control" id="id_Eosinofilos"
                                name="id_Eosinofilos">
                        </div>

                        <div class="col-md-3">
                            <strong style="font-size: 14px;">Eritrocitos</strong>
                            <input type="number" step="any" class="form-control" id="id_Eritrocitos"
                                name="id_Eritrocitos">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step="any" class="form-control" id="id_Procalcitonina"
                                name="id_Procalcitonina">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="lab_serologia" id="lab_serologia" class="form-control"
                                style="font-size: 14px;">
                                <option value="Seleccione">Seleccione</option>
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                        ...
                        <div class="col-md-6" id="serologia_resultado" style="display: none;">
                            ...
                            <select name="resultado_cultivo" id="resultado_serologia" class="form-control"
                                style="font-size: 14px;">
                        ...
                        <div class="col-md-6" id="resul_pcr" style="display: none;">
                            ...
                            <select name="resultado_PCR" id="resultado_PCR" class="form-control"
                                style="font-size: 14px;">
                                <option value="0">Selecione</option>
                                <option value="Positivo">Positivo</option>
                                <option value="Negativo">Negativo</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" id="cultivo_resultado" style="display: none;">
                            ...
                            <select name="resultado_cultivo" id="resultado_cultivo" class="form-control"
                                style="font-size: 14px;">
                                <option value="0">Selecione</option>
                                <option value="Positivo">Positivo</option>
                                <option value="Negativo">Negativo</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="lab_tomografia" id="lab_tomografia" class="form-control"
                                style="font-size: 14px;">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="col-md-6" id="resultado_dxRFC" style="display: none;">
                            ...
                            <input type="text" step="any" class="form-control" id="resultado_tomografia"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="lab_Ultrasonido" id="lab_Ultrasonido" class="form-control"
                                style="font-size: 14px;">
                                <option value="Negado">Negado</option>
                                <option value="Si">Si</option>
                            </select>
                        ...
                        <div class="col-md-6" id="ultrasonido_resultado" style="display: none;">
                            ...
                            <input type="text" step="any" class="form-control" id="resultado_Ultrasonido"
                                name="resultado_Ultrasonido">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" id="biopsia_resultado" style="display: none;">
                            ...
                            <input type="text" step="any" class="form-control" id="resultado_Biopsia"
                                name="resultado_Biopsia">
                        </div>
                    </div><!--=========== DIV ROW BIOPSIA================-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" id="id_refe" style="display: none;">
                            ...
                            <input type="text" step="any" class="form-control" id="resultado_referencia"
