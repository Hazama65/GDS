    ...
    <!--    59 meses -->
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="checkbox" name="No_doloroso" id="No_doloroso" value="Si" style="font-size:14px;">
                </div>
            ...
            <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="checkbox" name="No_Indurado" id="No_Indurado" value="Si" style="font-size:14px;">
                </div>
        </div><br>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="checkbox" name="Eritematoso" id="Eritematoso" value="Si" style="font-size: 14px;">
                </div>

                <div class="col-md-3">
                    <span style="font-size: 14px;">Hipertermico</span>
                    <input type="checkbox" name="Hipertermico" id="Hipertermico" value="Si" style="font-size: 14px;">
                </div>

    
                <div class="col-md-3">
                        <span style="font-size: 14px;">Con Secreción</span>
                        <input type="checkbox" name="con_Secrecion" id="con_Secrecion" value="Si" style="font-size: 14px;">
                    </div>
    
                    <div class="col-md-3">
                        <span style="font-size: 14px;">Sin Secreción</span>
                        <input type="checkbox" name="sin_secrecion" id="sin_secrecion" value="Si" style="font-size: 14px;">
                    </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="checkbox" name="bien_delimitado" id="bien_delimitado" value="Si" style="font-size: 14px;">
                </div>

                <div class="col-md-3">
                    <span style="font-size: 14px;">Mal Delimitado</span>
                    <input type="checkbox" name="mal_delimitado" id="mal_delimitado" value="Si" style="font-size: 14px;">
                </div>
        ...
        <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="checkbox" name="cambios_coloracion" id="cambios_coloracion" value="Si" style="font-size: 14px;">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="checkbox" name="sin_cambios" id="sin_cambios" value="Si" style="font-size:14px;">
                </div>
    ...
    <div class="row">
            ...
            <div class="container text-center" id="etiologia">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="checkbox" name="etiologia_VEB" id="etiologia_VEB" value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 14px;">CMV</span>
                        <input type="checkbox" name="etiologia_CMV" id="etiologia_CMV" value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-1">
                        <span style="font-size: 14px;">TB</span>
                        <input type="checkbox" name="etiologia_TB" id="etiologia_TB" value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 14px;">B19</span>
                        <input type="checkbox" name="etiologia_B19" id="etiologia_B19" value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 14px;">Bocio</span>
                        <input type="checkbox" name="etiologia_bocio" id="etiologia_bocio"  value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-3">
                        <span style="font-size: 14px;">Rubéola</span>
                        <input type="checkbox" name="etiologia_rubeola" id="etiologia_rubeola" value="Si" style="font-size: 14px;">
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="checkbox" name="etioligia_inflamatorio" id="etioligia_inflamatorio" value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 14px;">Parvovirus</span>
                        <input type="checkbox" name="etiologia_parvovirus" id="etiologia_parvovirus" value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 14px;">Varicela</span>
                        <input type="checkbox" name="etiologia_varicela" id="etiologia_varicela"  value="Si" style="font-size: 14px;">
                    </div>
        ...
        <div id="tx"
            ...
            <div class="row " >
                    <div class="col-md-2">
                        ...
                        <input type="checkbox" name="tx_Isonicida" id="tx_Isonicida" value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 14px;">Rifampicina</span>
                        <input type="checkbox" name="tx_Rifampicina" id="tx_Rifampicina" value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 14px;">Pirazinamida</span>
                        <input type="checkbox" name="tx_Pirazinamida" id="tx_Pirazinamida" value="Si" style="font-size: 14px;">
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 14px;">Etambutol</span>
                        <input type="checkbox" name="tx_Etambutol" id="tx_Etambutol" value="Si" style="font-size: 14px;">
                    </div>
        </div>
        </div>
