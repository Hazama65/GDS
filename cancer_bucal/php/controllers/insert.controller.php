<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $connectionDB->insertData($Tables[1], $Data_antecedentes);
        ...
        foreach ($Data_hvc as $key => $value) {
            $Data_hvc[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[2], $Data_hvc);
        ...
        foreach ($Data_afecciones_orales as $key => $value) {
            $Data_afecciones_orales[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[3], $Data_afecciones_orales);
        ...
        foreach ($Data_lesion_orales as $key => $value) {
            $Data_lesion_orales[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[4], $Data_lesion_orales);
        ...
        foreach ($Data_ubicacion_derecha as $key => $value) {
            $Data_ubicacion_derecha[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[5], $Data_ubicacion_derecha);
        ...
        foreach ($Data_ubicacion_izquierda as $key => $value) {
            $Data_ubicacion_izquierda[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[6], $Data_ubicacion_izquierda);
        ...
        foreach ($Data_atencion_clinica_histo_inmuno as $key => $value) {
            $Data_atencion_clinica_histo_inmuno[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[7], $Data_atencion_clinica_histo_inmuno);
        ...
        foreach ($Data_tratamiento1 as $key => $value) {
            $Data_tratamiento1[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[8], $Data_tratamiento1);
        ...
        foreach ($Data_tratamiento2 as $key => $value) {
            $Data_tratamiento2[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[9], $Data_tratamiento2);
        ...
        foreach ($Data_tratamiento3 as $key => $value) {
            $Data_tratamiento3[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[10], $Data_tratamiento3);
        ...
        foreach ($Data_exito_defuncion as $key => $value) {
            $Data_exito_defuncion[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[11], $Data_exito_defuncion);
