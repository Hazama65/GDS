...
<body>
    ...
    <div class="container1" style="height: 40px;
        ...
        <strong style="margin: 0 auto; color: aliceblue; font-size:20px;">REHABILITACIÓN</strong>
    </div>
    ...
    <div class="container" style="center">
        <div class="cards">
            <div class="card">
                <img src="img/censo_rehabilitacion.jpg" alt="Imagen 1">
                <br>
                <a href="../../rehabilitacion" class="btn btn-success">Censo Rehabilitación</a>
            </div>
            <div class="card">
                <img src="img/estadistica_rehabilitacion.jpg" alt="Imagen 2">
                <br>
                <a href="../estadistica_rehabi" class="btn btn-success">Estadística de Rehabilitación</a>
            </div>
