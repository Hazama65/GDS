...
<head>
    ...
    <title>Hemodinamia</title>
</head>
<body>

    <header>
        <h5 style="color:aliceblue; margin-top: 15px;">
        <i class="bi bi-hospital"></i> Hemodinamia</h5>
        <br>
    ...
    <div  style="padding: 20px;" class="btn-group" role="group" aria-label="Basic outlined example" >
        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ModalHemodinamia">
                            ...
                            <?php
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo $nombrePaciente;
                                        echo '<a href="editar_hemodinamia.php?id=' . $id_paciente . '">';
