...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT permiso.typetoken FROM users INNER JOIN permiso ON permiso.id_token = users.id_token WHERE username = :username AND password = :password";
    ...
    if (count($data) == 0) {
        ...
        $_SESSION['system_type'] = $data[0]['typetoken']; // Registrar el tipo de sistema en la sesión
