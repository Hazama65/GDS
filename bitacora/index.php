...
<head>
    ...
    <title>Valores Críticos </title>
</head>

<body>

    <header>
        <h5 class="bi bi-chat-square-text" style="color:rgb(243, 243, 243); margin-top: 10px;">Valores Críticos</h5>
        <br>
    ...
    <div style="padding: 20px;" class="btn-group" role="group" aria-label="Basic outlined example">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bitacora">
