            ...
            <div class="custom-form  custom-container">
                <form class="d-flex flex-wrap">
                    ...
                    <div class=" col-md-4 form-group">
                        ...
                        <input type="number" class="form-control" id="NIHSS_escalas" readonly>
                    </div>

                    <div class="col-md-4 form-group">
                        <label for="BARTHEL">BARTHEL</label>
                        <input type="number" class="form-control" id="BARTHEL_escalas"  readonly>
                    </div>

                    <div class="col-md-4 form-group">
                        <label for="FIM">FIM</label>
                        <input type="number" class="form-control" id="FIM_escalas"  readonly>
                    </div>

                    <div class=" col-md-4 form-group">
                        <label for="RANKIN">RANKIN</label>
                        <input type="number" class="form-control" id="RANKIN_escalas" readonly>
                    </div>

                    <div class=" col-md-4 form-group">
                        <label for="MOTRICITY">MOTRICITY INDEX</label>
                        <input type="number" class="form-control" id="MOTRICITY_escalas"  readonly>
                    </div>

                    <div class="col-md-4 form-group">
                        <label for="MARCHA">MARCHA FAC</label>
                        <input type="number" class="form-control" id="MARCHA_escalas" readonly>
                    </div>
