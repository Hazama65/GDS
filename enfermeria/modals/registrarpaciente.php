  ...
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Productividad Diaria de Hojas Quirúrgicas</h1>
            ...
            <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" id="productividad_a" name="productividad_a">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <span class="input-group-text" style="background-color: mintcream;">Verificación de actividades (surtimiento CEYE, Biomédico)</span>
