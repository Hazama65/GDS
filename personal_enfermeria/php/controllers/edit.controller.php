...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $query = "SELECT dp.*,ia.*,ctr.*,dl.*,co.*,cap.*
    ...
    if (!empty($AllData)) {
        foreach ($AllData as $data) {
            ...
            $Otro_empleo = $data['Otro_empleo'];
            $antigüedad = $data['antigüedad'];
            $tipo_contratacion = $data['tipo_contratacion'];
            $otro_contratacion = $data['otro_contratacion'];
            ...
            $competencias_profesionales = $data['competencias_profesionales'];
