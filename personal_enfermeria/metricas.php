        ...
        <div class="modal-content">
          ...
          <div class="body-container">
            ...
            <div class="text-center mt-3">
              <button class="btn btn-success" onclick="exportToExcel('tabla-turnos-areas','Turnos')">Exportar a Excel</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="modal-content">
          ...
          <div class="body-container">
            ...
            <div class="text-center mt-3">
              <button class="btn btn-success" onclick="exportToExcel('tabla-servicios-areas','Servicios')">Exportar a Excel</button>
            </div>
          </div>
        </div>
      </div>
