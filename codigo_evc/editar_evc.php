        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input id="fecha" name="fecha" type="date" onblur="curp2date();" class="control form-control" style="font-size: 13px;" value="<?php echo $fecha_nacimiento; ?>">
                </div>

                <div class="col-md-4">
                    <strong style="font-size: 13px;">Sexo</strong>
                    <input type="text" class="control form-control" id="sexo" onclick="curp2date();" name="sexo" style="font-size: 13px;" value="<?php echo $sexo; ?>">
                </div>


                <div class="col-md-4">
                    <strong style="font-size: 13px;">Edad de Ingreso</strong>
                    <input id="edad" name="edad" type="number" class="control form-control" style="font-size: 13px;" value="<?php echo $edad; ?>">
                </div>

                <div class="col-md-6" style="display:none">
                    <strong style="font-size: 13px; ">Fecha</strong>
                    <input id="fecha_Actual" name="fecha_Actual" type="date" class="control form-control" style="font-size: 13px;">
                </div>

                <div class="col-md-3" style="display:none">
                    <strong style="font-size: 13px; ">Horario</strong>
                    <input id="tiempo" name="tiempo" type="time" class="control form-control" style="font-size: 13px;" style="display: none;">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px; ">Fecha de Sintomas</strong>
                    <input id="fecha_inicio" name="fecha_inicio" type="date" class="control form-control" style="font-size: 13px;" value="<?php echo $fecha_sintomas; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px; ">Inicio de Sintomas</strong>
                    <input id="inicio_sintomas" name="inicio_sintomas" type="time" class="control form-control" style="font-size: 13px;" value="<?php echo $inicio_sintomas; ?>">
                </div>
                ...
                <div class="row"> <!--ROW DE ESCALA FACE  -->
                    ...
                    <div class="col-md-3" id="escala_face">
                        <strong style="font-size: 13px;">Cara</strong>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="control form-control" id="resultado_time" name="resultado_time" style="font-size: 13px;" value="<?php echo $time; ?>">
                    </div>
                ...
                <div class="col-md-12" id="escala_nihss">
                    <i><a style="font-size: 13px; margin-top: 50px;" href="https://www.rccc.eu/ppc/indicadores/Neuro/NIHSS.html" target="_blank">Escala NIHSS</a></i>
                ...
                <div class="container" id="parametros_nihss" style="display: none;">
                    <div class="row">
                        ...
                        <div class="col-md-12" id="fecha_sangrado_1" style="display: none;">
                            ...
                            <input type="date" class="control form-control" id="fecha_sangrado" name="fecha_sangrado" style="font-size: 13px;" value="<?php echo $fecha_sangrado; ?>">
                        </div>
                ...
                <div class="row "> <!-- DIV DE ROW DEL FACTOR DE RIESGO-->
                    ...
                    <div class="col-md-2">
                        <span style="font-size: 13px;">Hipertensión</span>
                        <input type="checkbox" name="Hipertension" id="hipertension" value="Si" style="font-size: 13px;" <?php if ($hipertension == 'Si') echo "checked"; ?>>
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 13px;">Diabetes</span>
                        <input type="checkbox" name="Diabetes" id="Diabetes" value="Si" style="font-size: 13px;" <?php if ($diabetes == 'Si') echo "checked"; ?>>
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 13px;">Tabaquismo</span>
                        <input type="checkbox" name="Tabaquismo" id="Tabaquismo" value="Si" style="font-size: 13px;" <?php if ($tabaquismo == 'Si') echo "checked"; ?>>
                    </div>

                    <div class="col-md-2">
                        <span style="font-size: 13px;">Covid</span>
                        <input type="checkbox" name="Covid" id="Covid" value="Si" style="font-size: 13px;" <?php if ($covid == 'Si') echo "checked"; ?>>
                    </div>

                    <div class="col-md-1"></div>

                    <div class="col-md-3 style=" margin-top: 10px;">
                        <span style="font-size: 13px;">Hiperlipidemia</span>
                        <input type="checkbox" name="Hiperlipidemia" id="Hiperlipidemia" value="Si" style="font-size: 13px;" <?php if ($hiperlipidemia == 'Si') echo "checked"; ?>>
                    </div>

                    <div class="col-md-3">
                        <span style="font-size: 13px;">Apnea de Sueño</span>
                        <input type="checkbox" name="Apnea" id="Apnea" value="Si" style="font-size: 13px;" <?php if ($apnea == 'Si') echo "checked"; ?>>
                    </div>

                    <div class="col-md-4">
                        <span style="font-size: 13px;">Enfermedad Cardiovascular </span>
                        <input type="checkbox" name="Apnea" id="Apnea" value="Si" style="font-size: 13px;" <?php if ($enfcardio == 'Si') echo "checked"; ?>>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <input id="tiempo_urgencias" name="tiempo_urgencias" type="time" class="control form-control" style="font-size: 13px;" value="<?php echo $hora_llegada; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px; ">Hora de Atención TRIAGE</strong>
                    <input id="tiempo_TRIAGE" name="tiempo_TRIAGE" type="time" class="control form-control" style="font-size: 13px;" value="<?php echo $hora_triage; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px;">Puerta-TRIAGE</strong>
                    <input type="text" id="puerta_triage" name="puerta_triage" class="control form-control" style="font-size: 13pz;" value="<?php echo $puerta_triage; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px; ">Hora de Atención CHOQUE</strong>
                    <input id="tiempo_CHOQUE" name="tiempo_CHOQUE" type="time" class="control form-control" style="font-size: 13px;" value="<?php echo $hora_choque; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px;">Puerta-URGENCIAS</strong>
                    <input type="text" id="puerta_urgencias" name="puerta_urgencias" class="control form-control" style="font-size: 13pz;" value="<?php echo $puerta_urgencias; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px; ">Hora de Realización TAC</strong>
                    <input id="tiempo_TAC" name="tiempo_TAC" type="time" class="control form-control" style="font-size: 13px;" value="<?php echo $hora_tac; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px;">Puerta-TAC</strong>
                    <input type="text" id="puerta_tac" name="puerta_tac" class="control form-control" style="font-size: 13pz;" value="<?php echo $puerta_tac; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px; ">Hora de Atención Equipo Multidisciplinario</strong>
                    <input id="tiempo_Multidisciplinario" name="tiempo_Multidisciplinario" type="time" class="control form-control" style="font-size: 13px;" value="<?php echo $hora_em; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px;">Puerta-MÉDICOS</strong>
                    <input type="text" id="puerta_medicos" name="puerta_medicos" class="control form-control" style="font-size: 13pz;" value="<?php echo $puerta_medicos; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px; ">Hora de Inicio de Trombolisis</strong>
                    <input id="tiempo_Trombolisis" name="tiempo_Trombolisis" type="time" class="control form-control" style="font-size: 13px;" value="<?php echo $hora_trombo; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px;">Puerta-AGUJA</strong>
                    <input type="text" id="puerta_aguja" name="puerta_aguja" class="control form-control" style="font-size: 13pz;" value="<?php echo $puerta_aguja; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px; ">Hora de Ingreso a Terapia</strong>
                    <input id="tiempo_Terapia" name="tiempo_Terapia" type="time" class="control form-control" style="font-size: 13px;" value="<?php echo $hora_terapia; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px;">Terapia Intensiva</strong>
                    <input type="text" id="puerta_terapia" name="puerta_terapia" class="control form-control" style="font-size: 13pz;" value="<?php echo $terapia_intensiva; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px; ">Hora de TAC-Control</strong>
                    <input id="tiempo_tac" name="tiempo_tac" type="time" class="control form-control" style="font-size: 13px;" value="<?php echo $hora_tac_control; ?>">
                </div>

                <div class="col-md-6">
                    <strong style="font-size: 13px;">TAC-Control</strong>
                    <input type="text" id="puerta_taccontrol" name="puerta_taccontrol" class="control form-control" style="font-size: 13pz;" value="<?php echo $tac_control; ?>">
                </div>
                ...
                <div class="row"> <!--  div del row de Escalas de Rehabilitacion -->
                    ...
                    <div class="col-md-6">
                        <strong style="font-size: 13px; margin-top: 50px;">Val. Inicial de Rehabilitación</strong>
                    ...
                    <div class="col-md-6">
                        <strong style="font-size: 13px; margin-top: 50px;">Val. Rehabilitación Hospitalaria</strong>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="any" class="form-control" id="fim_inicial" name="fim_inicial" style="font-size: 13px;" value="<?php echo $fim; ?>">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="rank" id="rank" class="form-control" style="font-size: 13px;">
                            ...
                            <option value="2 Incapacidad Leve. Incapaz de realizar actividades  previas  pero capaz de  hacer alguna actividad sin asistencia ." <?php if ($rankin == '2 Incapacidad Leve. Incapaz de realizar actividades  previas  pero capaz de  hacer alguna actividad sin asistencia .') echo 'selected'; ?>>
                            ...
                            <option value="4 Incapacidad Moderadamente Severa. Incapaz de caminar sin ayuda e incapaz de realizar sus necesidades corporales sin ayuda" <?php if ($rankin == '4 Incapacidad Moderadamente Severa. Incapaz de caminar sin ayuda e incapaz de realizar sus necesidades corporales sin ayuda') echo 'selected'; ?>>
                            ...
                            <option value="5 Incapacidad Severa  Confinado a cama,incontinente y requiere cuidado constante." <?php if ($rankin == '5 Incapacidad Severa  Confinado a cama,incontinente y requiere cuidado constante.') echo 'selected'; ?>>5
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="number" step="any" class="form-control" id="motri" name="motri" style="font-size: 13px;" value="<?php echo $motri; ?>">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" step="any" class="form-control" id="agatha" name="agatha" style="font-size: 13px;" value="<?php echo $agatha; ?>">
                    </div>
                ...
                <div class="col-md-3" id="dolor_neuropatico" style="display:none">
                    ...
                    <input type="text" class="control form-control" id="neuropatico" name="neuropatico" style="font-size: 13px;" value="<?php echo $tipo_neuro; ?>">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="control form-control" id="neuropsicologia" name="neuropsicologia" style="font-size: 13px;" value="<?php echo $neuro; ?>">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="control form-control" id="Equilibrio" name="Equilibrio" style="font-size: 13px;" value="<?php echo $equilibrio; ?>">
                </div>
                <div class="form-header">
                ...
                <div class="col-md-12">
                    ...
                    <i><a style="font-size: 13px; margin-top: 50px;" href="guiaGOSE.php" target="_blank">Instructivos</a></i>
