...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $Data_seguimiento = array(
        'nombbre_seguimiento'         => $_POST['nombbre_seguimiento'],
        'tipo_error'                  => $_POST['tipo_error'],
        'error'                       => $_POST['error'],
        'medicamento_erroneo'         => $_POST['medicamento_erroneo'],
        'inapropiada_medic'           => $_POST['inapropiada_medic'],
        'omision'                     => $_POST['omision'],
        'dosis_incorrecta'            => $_POST['dosis_incorrecta'],
        'tratamiento_incorrecta'      => $_POST['tratamiento_incorrecta'],
        'monitorizacion_insuficiente' => $_POST['monitorizacion_insuficiente'],
        ...
        'Forma3'                      => $_POST['Forma3'],
        'Medicamentos_Involucrado'    => $_POST['Medicamentos_Involucrado'],
        'descripcion_investigacion'   => $_POST['descripcion_investigacion'],
        'evidencia_inves'             => $_POST['evidencia_inves'],
        'file'                        => $_POST['file'],
        'Medicamento_categoria'       => $_POST['Medicamento_categoria'],
        'error_potencial'             => $_POST['error_potencial'],
        'Error_sindaño'               => $_POST['Error_sindaño'],
        'error_condaño'               => $_POST['error_condaño'],
        'Error_Mortal'                => $_POST['Error_Mortal'],
        'conclusion_investigacion'    => $_POST['conclusion_investigacion'],
        'conclusiondes_investigacion' => $_POST['conclusiondes_investigacion'],
        'estrategia_preve'            => $_POST['estrategia_preve'],
        'prevencion_investigacion'    => $_POST['prevencion_investigacion'],
        'analisis_causa'              => $_POST['analisis_causa'],
        'raiz_descrip'                => $_POST['raiz_descrip'],
        'id_paciente'                 => $Result_pacientes
    );
