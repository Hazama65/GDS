...
<body>
    <table class="table table-striped table-hover table-bordered tabla-consulta">
        <thead>
            ...
            <tr>
                <th scope="col" style="color: white; background-color: rgb(106, 158, 218);"> Datos del Paciente</th>
        ...
        <tbody style="font-size:13px;" class="table-bordered">
            ...
            <tr>
                <td class="estilo-celda">NIHSS-Valor</td>
            ...
            <tr>
                <td class="estilo-celda">Barthel-Valor</td>
            ...
            <tr>
                <td class="estilo-celda">Escala FIM-Valor</td>
            ...
            <tr>
                <td class="estilo-celda">Rankin-Valor</td>
            ...
            <tr>
                <td class="estilo-celda">Marcha FAC-Valor</td>
