...
<body>
    ...
    <header class="custom-header">
        <h3 class="bi bi-calculator" style="color:rgb(243, 243, 243); margin-top: 15px;">Registro Paciente-Escalas</h3>
        <br>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5" style="margin-right: 80px;">
                        ...
                        <form id="escalasForm" method="POST">
                            <div class="custom-container">
                                <div class="row custom-row align-items-center justify-content-center">
                                    <div class="form-header">
                                        <h5 class="custom-title" style="text-align: center;
                                background-color:rgb(115, 64, 134);
                                color: aliceblue;
                                margin-top:10px;
                                font-size: 14px;">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="nombre_paciente" name="nombre_paciente" type="text"
                                            class="control form-control" value="" style="font-size: 13px;">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="control form-control" id="sexo" onclick="curp2date();"
                                            name="sexo" style="font-size: 13px;" readonly>
                                    </div>
                                </div>
                            </div>

                            <!-- Campos del formulario debajo del primer contenedor -->
                            <div class="custom-form  custom-container">
                                <div class="row">
                                    ...
                                    <div class=" col-md-6 form-group">
                                        ...
                                        <input type="text" class="form-control" id="NIHSS_escala" name="NIHSS_escala"
                                            readonly>
                                    </div>

                                    <div class="col-md-6 form-group">
                                        <label for="BARTHEL">BARTHEL</label>
                                        <input type="number" class="form-control" id="BARTHEL" name="BARTHEL" readonly>
                                    </div>
                                    ...
                                    <div class=" col-md-6 form-group">
                                        ...
                                        <input type="number" class="form-control" id="RANKIN" name="RANKIN" readonly>
                                    </div>

                                    <div class=" col-md-6 form-group">
                                        <label for="RANKIN">RANKIN Valor</label>
                                        <input type="text" class="form-control" id="RANKIN_escala" name="RANKIN_escala"
                                            readonly>
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="number" class="form-control" id="MARCHA" name="MARCHA" readonly>
                                    </div>

                                    <div class="col-md-6 form-group">
                                        <label for="MARCHA">MARCHA FAC Valor</label>
                                        <input type="text" class="form-control" id="MARCHA_escala" name="MARCHA_escala"
                                            readonly>
                                    </div>
                    ...
                    <div class="col-md-6 custom-container" style="max-height: 500px">
                        <div class="row custom-row align-items-center justify-content-center">
