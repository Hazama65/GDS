...
<body>
    ...
    <div class="container1" style="height: 40px;
        ...
        <strong style="margin: 0 auto; color: aliceblue; font-size:20px;">CISFA</strong>
    </div>
    ...
    <div class= "container" style="center;">
        <div class="cards">
            <div class="card">
                <img src="img/medicamentos.jpg" alt="Imagen 1">
                <br>
                <a href="../medicamentos" class="btn btn-success">Abasto de medicamentos</a>
            </div>
        </div>
