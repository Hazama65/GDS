...
<body>
    ...
    <header>
        <strong style="color:aliceblue; margin-top: 15px; font-size: 25px;">ENDOSCOPIA</strong><br>
    ...
    <!-- ESTE ES EL BLOQUE DE LOS BOTONES-->
        ...
        <div  style="padding: 20px;" class="btn-group" role="group" aria-label="Basic outlined example" >
            ...
            <a href="graficas_endoscopia.php">
                        ...
                        <input type="text" id="search" placeholder="Buscar Paciente...">
                            <ul id="patient-list">
                                <?php
                                    ...
                                    // Consulta SQL
                                    $sql = "SELECT id_paciente, nombre_paciente FROM pacientes";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo $nombrePaciente;
                                            echo '<a href="editar_endoscopia.php?id=' . $id_paciente . '">';
