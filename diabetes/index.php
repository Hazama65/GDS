...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-4" width="100%" height="800px" style="margin-bottom: 100px; overflow-y: auto;">
            ...
            <div class="col-7">
                <div class="container">
                    ...
                    <div id="tabla-seguimiento" class="tabla-seguimiento" style="height: 350px; overflow-y: auto; margin-bottom: 20px;"></div>
