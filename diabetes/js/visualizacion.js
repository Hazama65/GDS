document.addEventListener('DOMContentLoaded', function () {
    ...
    function mostrarIdPaciente(event) {
        ...
        document.getElementById('borrar_paciente').setAttribute("data-id-seg", 0 );
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                opcionesSelect.forEach(function (opcion) {
                    ...
                    option.value = opcion.id_seg; // Ajusta según tus datos
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function mostrarSeguimiento(valorSeleccionado, textoSeleccionado) {
        ...
        document.getElementById('borrar_paciente').setAttribute("data-id-seg", valorSeleccionado);
