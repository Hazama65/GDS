    ...
    <table class="table table-striped table-hover table-bordered tabla-consulta">
        ...
        <tbody style="font-size:13px;" class="table-bordered">
            ...
            <tr>
                ...
                <td>
                    <?php echo $estudio_socioEconomico ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_materno_dm ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Materna - Tipo DM</td>
                <td>
                    <?php echo $abuela_materna_dm ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_paterno_dm ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Paterna - Tipo DM</td>
                <td>
                    <?php echo $abuela_paterna_dm ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $no_hermanas_dm ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Número de Hermanos- DM</td>
                <td>
                    <?php echo $no_hermanos_dm ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_materno_has ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Materna - HAS</td>
                <td>
                    <?php echo $abuela_materna_has ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_paterno_has ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Paterna - HAS</td>
                <td>
                    <?php echo $abuela_paterna_has ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $no_hermanas_has ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Número de Hermanos- HAS</td>
                <td>
                    <?php echo $no_hermanos_has ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_materno_evc ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Materna - ECV</td>
                <td>
                    <?php echo $abuela_materna_evc ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_paterno_evc ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Paterna - ECV</td>
                <td>
                    <?php echo $abuela_paterna_evc ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $no_hermanas_evc ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Número de Hermanos- ECV</td>
                <td>
                    <?php echo $no_hermanos_evc ; ?>
                </td>
            </tr>
            <!--===============HEREDOFAMILIARES  CI =======================-->
            <tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_materno_ci ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Materna - CI</td>
                <td>
                    <?php echo $abuela_materna_ci ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_paterno_ci ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Paterna - CI</td>
                <td>
                    <?php echo $abuela_paterna_ci ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $no_hermanas_ci ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Número de Hermanos- CI</td>
                <td>
                    <?php echo $no_hermanos_ci ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_materno_htg ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Materna - HTG</td>
                <td>
                    <?php echo $abuela_materna_htg ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_paterno_htg ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Paterna - HTG</td>
                <td>
                    <?php echo $abuela_paterna_htg ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $no_hermanas_htg ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Número de Hermanos- HTG</td>
                <td>
                    <?php echo $no_hermanos_htg ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_materno_ldl ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Materna - H-LDL</td>
                <td>
                    <?php echo $abuela_materna_ldl ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $abuelo_paterno_ldl ; ?>
                </td>
            </tr>
            <tr>
                <td class="estilo-celda">Abuela Paterna - H-LDL</td>
                <td>
                    <?php echo $abuela_paterna_ldl ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $insuficiencia_cardiaca ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $amputaciones_transmetatarsiana ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $lateralidad_Transmetatarsiana ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $amputaciones_infracondilea ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $lateralidad_Infracondilea ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $amputaciones_Supracondilea ; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $lateralidad_Supracondilea ; ?>
                </td>
            </tr>
