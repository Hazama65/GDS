                ...
                <form id="CM_form" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input id="nombre_px" name="nombre_px" type="text" class="control form-control" value=""
                                style="font-size: 13px;">
                        </div>
    
                        <div class="col-md-4">
                            <strong style="font-size: 13px;">CURP</strong>
                            <input id="curp" name="curp" type="text" class="control form-control" value=""
                                style="font-size: 13px;">
                        </div>
    
                        <div class="col-md-4">
                            <strong style="font-size: 13px;">Género</strong>
                            <input id="genero" name="genero" type="text" class="control form-control" value=""
                                style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="Raza" name="Raza" type="text" class="control form-control" value=""
                                style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="control form-control" id="Presion_sistolica"
                                name="Presion_sistolica" style="font-size: 13px;">
                        </div>
    
                        <div class="col-md-4">
                            <strong style="font-size: 13px;">Presión Diastólica </strong>
                            <input type="number" class="control form-control" id="Presion_Diastolica"
                                name="Presion_Diastolica" style="font-size: 13px;">
                        </div>
    
    
                        <div class="col-md-4">
                            <strong style="font-size: 13px;">Frecuencia Cardíaca</strong>
                            <input id="FC" name="FC" type="number" class="control form-control" value=""
                                style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="control form-control" id="peso" name="peso"
                                style="font-size: 13px;">
                        </div>
    
                        <div class="col-md-4">
                            <strong style="font-size: 13px;">Talla (m)</strong>
                            <input type="number" class="control form-control" id="talla" name="talla"
                                style="font-size: 13px;">
                        </div>
                        ...
                        <div class="container"
                            style="display: grid; grid-template-columns: repeat(4, 2fr); grid-gap: 20px;">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input ra-checkbox" type="checkbox" id="renal_cronica"
                                    name="renal_cronica" value="renal_cronica_pat">
                                <label class="form-check-label" for="renal_cronica_patologico"
                                    style="font-size: 13px;">Enfermedad Renal Cronica</label>
                            </div>
    
                            <div class="form-check form-check-inline">
                                <input class="form-check-input ra-checkbox" type="checkbox" id="Hipertension"
                                    name="Hipertension" value="Hipertension_pat">
                                <label class="form-check-label" for="Hipertension_patologico"
                                    style="font-size: 13px;">Hipertensión Arterial</label>
                            </div>
    
                            <div class="form-check form-check-inline">
                                <input class="form-check-input ra-checkbox" type="checkbox" id="Tabaquismo"
                                    name="Tabaquismo" value="Tabaquismo_pat">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input ra-checkbox" type="checkbox" id="Antecedentecancer_mama"
                                    name="Antecedentecancer_mama" value="Antecedentecancer_mama_pat">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input ra-checkbox" type="checkbox" id="Antecedentes_ninguna"
                                    name="Antecedentes_ninguna" value="Antecedentes_ninguna_pat">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2" style="text-align: center;">
                                    ...
                                    <input type="checkbox" class="form-check-input ra-checkbox" name="Padre_cancer_Prostata"
                                        ...
                                        style="font-size:13px; margin: 5px auto; display: block;">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2" style="text-align: center;">
                                    ...
                                    <input type="checkbox" name="Antecedentes_Mama" id="Madre_cancer_Mama"
                                        value="Madre_cancer_Mama" style="font-size:14px; margin: 5px auto; display: block;">
                                </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="Esta_Embarazada" id="Esta_Embarazada" class="form-select"
                                style="font-size: 13px;">
                                <option value="Seleccione">Seleccione</option>
                                <option value="Si">Si</option>
                                <option value="No">No</option>
                        ...
                        <div class="col-md-3" id="Fecha_probable" style="display:none;">
                            ...
                            <input type="date" class="control form-control" id="fecha_probableParto"
                                name="fecha_probableParto" style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-2" id="Tiempo_lactancia" style="display:none;">
                            ...
                            <input type="text" class="control form-control" id="Tiempo" name="Tiempo"
                                style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="control form-control" id="Paras" name="Paras"
                                style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="date" class="control form-control" id="Fecha_primeraAtencion"
                                name="Fecha_primeraAtencion" style="font-size: 13px;">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="BIRADS_Hospital" id="BIRADS_Hospital" class="form-select"
                                style="font-size: 13px;">
                                <option value="Seleccione">Seleccione</option>
                                <option value="BR0">BR0 Estudio Insuficiente</option>
                                <option value="BRI">BRI Normal</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="Compromiso_linfatico" id="Compromiso_linfatico" class="form-select"
                                ...
                                <option value="N2a">N2a: Metástasis en Nódulo Ipsilateral, Mayor de 3cm Menor de 6cm
                                </option>
                                <option value="N2b">N2b: Metástasis en múltiples Nódulos Ipsilaterales Mayores a 6cm
                                </option>
                                <option value="N2c">N2c: Metástasis en Nódulos Bilaterales y Contralaterales Mayores a 6cm
                                </option>
                        ...
                        <div class="container" id="late_fecha_maste" style="display:none;">
                            <div class="row">
                                ...
                                <div class="col-md-6" id="fecha_latera_maste">
                                    ...
                                    <input type="date" class="control form-control" id="fecha_ATC"
                                        name="fecha_ATC" style="font-size: 13px;">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="Histopatologia" id="Histopatologia" class="form-select"
                                    style="font-size: 13px;">
                                    <option value="Sin Registro">Sin Registro</option>
                                    <option value="Si">Si</option>
                                    <option value="No">No</option>
                            ...
                            <div class="col-md-6" id="Histo_area" style="display:none;">
                                ...
                                <select name="Histopatologia_area" id="Histopatologia_area" class="form-select"
                                    ...
                                    <option value="Biopsia por aguja/Biopsia de otro lugar">Biopsia por aguja/Biopsia de
                                        otro lugar</option>
                                </select>
                            </div>
                            ...
                            <div class="container" id="DXHistopatologia" style="display:none;">
                                <div class="row">
                                    <div class="col-md-6" id="Dx_histopatologicoarea">
                                        ...
                                        <select name="Dx_Histopatologia_area" id="Dx_Histopatologia_area"
                            ...
                            <div class="container" id="Area_Inmunohistoquimica" style="display:none;">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="control form-control" id="Receptores_RE"
                                            name="Receptores_RE" style="font-size: 13px;">
                                    </div>
    
    
                                    <div class="col-md-4">
                                        <strong style="font-size: 13px;">Receptores Progesterona (RP)</strong>
                                        <input type="text" class="control form-control" id="Receptores_RP"
                                            name="Receptores_RP" style="font-size: 13px;">
                                    </div>
                            ...
                            <div class="col-md-6" id="Histo_areaMolecular" style="display:none;">
                                <strong style="font-size: 13px;">Área</strong>
                                <select name="Molecular_area" id="Molecular_area" class="form-select"
                                    style="font-size: 13px;">
                                    <option value="Sin Registro">Sin Registro</option>
                                    <option value="Mama Derecha">Mama Derecha</option>
                                    <option value="Mama Izquierda">Mama Izquierda</option>
                            ...
                            <div class="container" id="Molecular_estudios" style="display:none;">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select name="Luminal_A" id="Luminal_A" class="form-select"
                                            style="font-size: 13px;">
                                            <option value="Si">Si</option>
                                            <option value="No">No</option>
                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="Luminal_B" id="Luminal_B" class="form-select"
                                            style="font-size: 13px;">
                                            <option value="Si">Si</option>
                                            <option value="No">No</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="control form-control" id="fecha_ganglionar"
                                            name="fecha_ganglionar" style="font-size: 13px;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="control form-control" id="fecha_Mastectomia"
                                            name="fecha_Mastectomia" style="font-size: 13px;">
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="Quimioterapia" id="Quimioterapia" class="form-select"
                                    style="font-size: 13px;">
                                    <option value="Sin Registro">Sin Registro</option>
                                    <option value="Si">Si</option>
                                    <option value="No">No</option>
                            ...
                            <div class="col-md-6" id="quimio_antraciclinas" style="display:none;">
                                ...
                                <select name="Antraciclinas" id="Antraciclinas" class="form-select"
                                    style="font-size: 13px;">
                                    <option value="Sin Registro">Sin Registro</option>
                        ...
                        <div class="container" id="quimioterapia_1" style="display:none;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="control form-control" id="FechaInicio_QT"
                                        name="FechaInicio_QT" style="font-size: 13px;">
                                </div>
    
                                <div class="col-md-4">
                                    <strong style="font-size: 13px;">Fecha Ternmino</strong>
                                    <input type="date" class="control form-control" id="FechaTernmino_QT"
                                        name="FechaTernmino_QT" style="font-size: 13px;">
                                </div>
                                ...
                                <div class="container" id="Esquema_ady_neo" style="display:none;"> <br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Bevacizumab_Esquema" name="Bevacizumab_Esquema" value="Bevacizumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Ciclofosfamida_Esquema" name="Ciclofosfamida_Esquema"
                                                value="Ciclofosfamida"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Cisplatino_Esquema" name="Cisplatino_Esquema" value="Cisplatino"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Ctuximab_Esquema" name="Ctuximab_Esquema" value="Ctuximab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Docetaxel_Esquema" name="Docetaxel_Esquema" value="Docetaxel"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Etopósido_Esquema" name="Etopósido_Esquema" value="Etopósido"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Herceptin_Esquema" name="Herceptin_Esquema" value="Herceptin"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Lapatinib_Esquema" name="Lapatinib_Esquema" value="Lapatinib"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Paclitaxel_Esquema" name="Paclitaxel_Esquema" value="Paclitaxel"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Pembrolixumab_Esquema" name="Pembrolixumab_Esquema"
                                                value="Pembrolixumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Pertuzumab_Esquema" name="Pertuzumab_Esquema" value="Pertuzumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Trastuzumab_Esquema" name="Trastuzumab_Esquema" value="Trastuzumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="SinRegistro_Esquema" name="SinRegistro_Esquema" value="Sin Registro"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                ...
                                <div class="container" id="1erLinea_QT" style="display:none;"> <br>
                                    ...
                                    <div class="row">
                                        <label for="Palitaivos_1LINEAQT"
                                            style=" text-align: center; font-size: 14px;"><strong>1er Línea
                                                QT</strong></label> <br>
    
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">5FU</span>
                                            <input class="form-check-input ra-checkbox" type="checkbox" id="5fu" name="5fu"
                                                value="5fu_1QT" style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
    
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">AC</span>
                                            <input class="form-check-input ra-checkbox" type="checkbox" id="AC" name="AC"
                                                value="AC_1QT" style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Atezolizumab</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Atezolizumab_1QT" name="Atezolizumab_1QT" value="Atezolizumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Capecitabina</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Capecitabina_1QT" name="Capecitabina_1QT" value="Capecitabina"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Ciclofosfamida</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Ciclofosfamida_1QT" name="Ciclofosfamida_1QT" value="Ciclofosfamida"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Pembrolixumab</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Pembrolixumab_1QT" name="Pembrolixumab_1QT" value="Pembrolixumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                    ...
                                    <div class="row" id="fechas_1er">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="control form-control" id="FechaInicio_QTPaliativoz"
                                                name="FechaInicio_QTPaliativoz" style="font-size: 13px;">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="control form-control" id="FechaTermino_QTPaliativo"
                                                name="FechaTermino_QTPaliativo" style="font-size: 13px;">
                                        </div>
                                ...
                                <div class="container" id="2daLinea_QT" style="display:none;"> <br>
                                    <div class="row">
                                        <label for="Palitaivos_2daLINEAQT"
                                            style=" text-align: center; font-size: 14px;"><strong>2da Línea
                                                QT</strong></label> <br>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            ...
                                            <input class="form-check-input ra-checkbox" type="checkbox"
                                                id="Atezolizumab_2doQTP" name="Atezolizumab_2doQTP" value="Atezolizumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Bevacizumab</span>
                                            <input class="form-check-input ra-checkbox" type="checkbox"
                                                id="Bevacizumab_2doQTP" name="Bevacizumab_2doQTP" value="Bevacizumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Capecitabina</span>
                                            <input class="form-check-input ra-checkbox" type="checkbox"
                                                id="Capecitabina_2doQTP" name="Capecitabina_2doQTP" value="Capecitabina"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Ciclofosfamida</span>
                                            <input class="form-check-input ra-checkbox" type="checkbox"
                                                id="Ciclofosfamida_2doQTP" name="Ciclofosfamida_2doQTP"
                                                value="Ciclofosfamida"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Cisplatino</span>
                                            <input class="form-check-input ra-checkbox" type="checkbox"
                                                id="Cisplatino_2doQTP" name="Cisplatino_2doQTP" value="Cisplatino"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Docetaxel</span>
                                            <input class="form-check-input ra-checkbox" type="checkbox"
                                                id="Docetaxel_2doQTP" name="Docetaxel_2doQTP" value="Docetaxel"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Etopósido</span>
                                            <input class="form-check-input ra-checkbox" type="checkbox"
                                                id="Etopósido_2doQTP" name="Etopósido_2doQTP" value="Etopósido"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Herceptin</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Herceptin_2doQTP" name="Herceptin_2doQTP" value="Herceptin"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Lapatinib</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Lapatinib_2doQTP" name="Lapatinib_2doQTP" value="Lapatinib"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Paclitaxel</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Paclitaxel_2doQTP" name="Paclitaxel_2doQTP" value="Paclitaxel"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Pertuzumab</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Pertuzumab_2doQTP" name="Pertuzumab_2doQTP" value="Pertuzumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Trastuzumab</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="Trastuzumab_2doQTP" name="Trastuzumab_2doQTP" value="Trastuzumab"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                        ...
                                        <div class="col-md-2" style="text-align: center;">
                                            <span style="font-size: 13px; display: block;">Sin Registro</span>
                                            <input type="checkbox" class="form-check-input ra-checkbox"
                                                id="SinRegistro_2doQTP" name="SinRegistro_2doQTP" value="Sin Registro"
                                                style="font-size:14px; margin: 5px auto; display: block;">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="control form-control" id="FechaInicio_QT2Paliativo"
                                                name="FechaInicio_QT2Paliativo" style="font-size: 13px;">
                                        </div>
    
                                        <div class="col-md-6">
                                            <strong style="font-size: 13px;">Fecha Término QT</strong>
                                            <input type="date" class="control form-control" id="FechaTermino_QTP2aliativo"
                                                name="FechaTermino_QTP2aliativo" style="font-size: 13px;">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="Hormoterapia" id="Hormoterapia" class="form-select"
                                        style="font-size: 13px;">
                                        <option value="Sin registro">Sin registro</option>
                                        <option value="Si">Si</option>
                                        <option value="No">No</option>
                                ...
                                <div class="col-md-6" id="Esquema_her2" style="display:none;">
                                    ...
                                    <select name="Esquema_HER" id="Esquema_HER" class="form-select"
                                        style="font-size: 13px;">
                                        <option value="Sin Registro">Sin Registro</option>
                                ...
                                <div class="col-md-6" id="quimio_fechaQT" style="display:none;">
                                    ...
                                    <input id="fecha_fallecio" name="fecha_fallecio" type="date"
                                        class="control form-control" style="font-size: 13px;">
                                </div>
