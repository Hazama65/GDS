<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        foreach ($Data_signos_vitales_sometria as $key => $value) {
            $Data_signos_vitales_sometria[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[1], $Data_signos_vitales_sometria);
        ...
        foreach ($Data_antecedentes_patologicos as $key => $value) {
            $Data_antecedentes_patologicos[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[2], $Data_antecedentes_patologicos);
        ...
        $connectionDB->insertData($Tables[3], $Data_antecedentes_familiares);
        ...
        foreach ($Data_antecedentes_gineco as $key => $value) {
            $Data_antecedentes_gineco[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[4], $Data_antecedentes_gineco);
        ...
        foreach ($Data_antecedentes_emb as $key => $value) {
            $Data_antecedentes_emb[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[5], $Data_antecedentes_emb);
        ...
        $connectionDB->insertData($Tables[6], $Data_atencion_clinica);
        ...
        foreach ($Data_histopatologia as $key => $value) {
            $Data_histopatologia[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[7], $Data_histopatologia);
        ...
        foreach ($Data_inmuno as $key => $value) {
            $Data_inmuno[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[8], $Data_inmuno);
        ...
        foreach ($Data_molecular as $key => $value) {
            $Data_molecular[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[9], $Data_molecular);
        ...
        $connectionDB->insertData($Tables[10], $Data_tratamiento);
        ...
        foreach ($Data_quimio as $key => $value) {
            $Data_quimio[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[11], $Data_quimio);
        ...
        foreach ($Data_momento1 as $key => $value) {
            $Data_momento1[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[12], $Data_momento1);
        ...
        foreach ($Data_momento2 as $key => $value) {
            $Data_momento2[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[13], $Data_momento2);
        ...
        foreach ($Data_momento3 as $key => $value) {
            $Data_momento3[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[14], $Data_momento3);
        ...
        foreach ($Data_hhtht as $key => $value) {
            $Data_hhtht[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[15], $Data_hhtht);
        ...
        foreach ($Data_full_quimio as $key => $value) {
            $Data_full_quimio[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[16], $Data_full_quimio);
        ...
        foreach ($Data_radio_defun as $key => $value) {
            $Data_radio_defun[$key] = $connectionDB->escapeString($value);
        }
        $connectionDB->insertData($Tables[17], $Data_radio_defun);
