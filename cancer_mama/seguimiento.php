    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <select name="Seguimiento_Calidad_ECOG" id="Seguimiento_Calidad_ECOG" class="form-select" style="font-size: 13px;">
            ...
            <div class="col-md-3">
                ...
                <select name="ProgresionEnfermedad" id="ProgresionEnfermedad" class="form-select" style="font-size: 13px;">
            ...
            <div class="col-md-3" id="Fecha_progresion" style="display:none;">
                ...
                <input type="date" class="control form-control" id="fecha_progreEnfermedad" name="fecha_progreEnfermedad" style="font-size: 13px;">
            </div>
            ...
            <div class="col-md-3" id="Fecha_Recurrencia" style="display:none;">
                ...
                <input type="date" class="control form-control" id="Recurrencia_fecha" name="Recurrencia_fecha" style="font-size: 13px;">
            </div>

            <div class="col-md-3">
                <strong style="font-size: 13px;">Tipo Cuidados Paliativos</strong>
                <select name="tipo_cuidado_seguimiento" id="tipo_cuidado_seguimiento" class="form-select" style="font-size: 13px;">
                    <option value="Sin Registro">Sin Registro</option>
            ...
            <div class="col-md-3">
                ...
                <select name="Protocolo_clinico" id="Protocolo_clinico" class="form-select" style="font-size: 13px;">
                    <option value="Seleccione">Seleccione</option>
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                    <option value="Sin Registro">Sin Registro</option>
            ...
            <div class="col-md-3">
                ...
                <select name="Protocolo_Investigacion" id="Protocolo_Investigacion" class="form-select" style="font-size: 13px;">
                    <option value="Seleccione">Seleccione</option>
                    <option value="Si">Si</option>
                    <option value="No">No</option>
                    <option value="Sin Registro">Sin Registro</option>
            ...
            <div class="col-md-6">
                ...
                <input type="date" class="control form-control" id="Reintervencion_fecha" name="Reintervencion_fecha" style="font-size: 13px;">
            </div>

            <div class="col-md-6">
                <strong style="font-size: 13px;">Lateralidad QX</strong>
                <select name="Lateralidad_Seguimiento_QX" id="Lateralidad_Seguimiento_QX" class="form-select" style="font-size: 13px;">
                    <option value="Seleccione">Seleccione</option>
            ...
            <div class="col-md-4">
                ...
                <select name="Tratamiento_Seguimiento" id="Tratamiento_Seguimiento" class="form-select" style="font-size: 13px;">
                    <option value="Seleccione">Seleccione</option>
            ...
            <div class="col-md-6">
                <strong style="font-size: 13px;">Tipo</strong>
                <select name="Tipo_RadioterapiaSeguimiento" id="Tipo_RadioterapiaSeguimiento" class="form-select" style="font-size: 13px;">
                    <option value="Seleccione">Seleccione</option>
                    <option value="Sin Registro">Sin Registro</option>
            ...
            <div class="col-md-6">
                ...
                <input type="date" class="control form-control" id="Seguimiento_Iniciofecha" name="Seguimiento_Iniciofecha" style="font-size: 13px;">
            </div>
