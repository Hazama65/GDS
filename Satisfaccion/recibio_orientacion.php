...
<body>
    ...
    <h2 class="form-title" style="text-align: center;
        ...
        margin-top:0;
        font-size: 25px;
        font-family: 'Montserrat', 'sans-serif';"> ¿Recibió orientación por parte del personal,sobre los tramites que realizara?</h2>
    ...
    <main>
        ...
        <div class="age-container">
            ...
            <div class="card" onclick="redirectToPage('higiene_hospital.php')">
