        ...
        <div class="modal-content">
            <div class="modal-header custom-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">
                    <i class="bi bi-person-lines-fill"></i>Productividad Residentes Medicina Interna
                </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="nombre_responsable" id="nombre_responsable" class="form-control"
                                style="font-size: 13px;">
                                <option value="Sin Registro">SELECCIONE</option>
                                <option value="ANA MARÍA CRUZ HERNÁNDEZ">ANA MARÍA CRUZ HERNÁNDEZ</option>
                                <option value="CARLOS WALDO VARGAS">CARLOS WALDO VARGAS</option>
                                <option value="DANTE RIVERA ZETINA">DANTE RIVERA ZETINA</option>
                                <option value="DAVID CASTAÑEDA">DAVID CASTAÑEDA</option>
                                <option value="ELISEO PEREZ SILVA">ELISEO PEREZ SILVA</option>
                                <option value="EVELYN SAMANTHA PÉREZ HUERTA">EVELYN SAMANTHA PÉREZ HUERTA</option>
                                <option value="FERNANDO JIMÉNEZ FLORES">FERNANDO JIMÉNEZ FLORES</option>
                                ...
                                <option value="FRANCISCO GALLEGO SÁNCHEZ">FRANCISCO GALLEGO SÁNCHEZ</option>
                                <option value="GERARDO ROJAS MAGAÑA">GERARDO ROJAS MAGAÑA</option>
                                <option value="GUADALUPE BERENICE GARDUÑO ARRIAGA">GUADALUPE BERENICE GARDUÑO ARRIAGA</option>
                                <option value="GUADALUPE GARDUÑO ARRIAGA">GUADALUPE GARDUÑO ARRIAGA</option>
                                ...
                                <option value="JOSUE TLALPAN BUREOS">JOSUE TLALPAN BUREOS</option>
                                <option value="JUAN EDILBERTO RODRIGUEZ PIÑA">JUAN EDILBERTO RODRIGUEZ PIÑA</option>
                                <option value="LUIS ALFONSO COVARRUBIAS">LUIS ALFONSO COVARRUBIAS</option>
                                <option value="MARÍA ISABEL SILVA CRUZ">MARÍA ISABEL SILVA CRUZ</option>
                                <option value="MONICA HERRERA DURÁN">MONICA HERRERA DURÁN</option>
                                ...
                                <option value="SALVADOR HERNÁNDEZ">SALVADOR HERNÁNDEZ</option>
                                <option value="SANDY BADILLO DE LA PEÑA">SANDY BADILLO DE LA PEÑA</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="nombre_paciente" name="nombre_paciente" type="text" class="form-control" style="font-size: 14px;">
                        </div>
                        <!-- ***********************************PROCEDIMIENTOS*********************************** -->
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6" id="p_puncionlumbar">
                            ...
                            <select name="puncion_lumbar" id="puncion_lumbar" class="form-control"
                        ...
                        <div class="col-md-6" id="procedimientos" style="display: none;">
                            <strong style="font-size: 14px;">Punción Lumbar</strong>
                            <select name="conteo_pl" id="procedimientos123" class="form-control"
                                style="font-size: 14px;">
                ...
                font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="pl_lumbar1">
                                    ...
                                    <select name="intento_1" id="intento_1" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                ...
                                <div class="col-md-3" id="otros_1" name="otros_1" style="display: none;">
                                    ...
                                    <input id="pl_otros_1" name="pl_otros_1" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
            ...
            font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="pl_lumbar2">
                                    <span style="font-size: 14px;">Intento</span>
                                    <select name="intento_2" id="intento_2" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Exitoso">Exitoso</option>
                                        <option value="Fallido">Fallido</option>
                                ...
                                <div class="col-md-3" id="otros_2" name="otros_2" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="pl_otros_2" name="pl_otros_2" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="pl_lumbar3">
                                    <span style="font-size: 14px;">Intento</span>
                                    <select name="intento_3" id="intento_3" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Exitoso">Exitoso</option>
                                        <option value="Fallido">Fallido</option>
                                ...
                                <div class="col-md-3" id="otros_3" name="otros_3" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="pl_otros_3" name="pl_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="pro_intubacion" style="display: none;">
                            ...
                            <select name="conteo_intubacion" id="intubacion123" class="form-control"
                                style="font-size: 14px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="com_intubacion1">
                                    <span style="font-size: 14px;">Complicaciones</span>
                                    <select name="complicacion_intubacion_1" id="complicacion_intubacion_1"
                                ...
                                <div class="col-md-3" id="tipocomplicacion_intubacion11">
                                    ...
                                    <select name="tipocomplicacion_intubacion1" id="tipocomplicacion_intubacion1"
                                        class="form-control" style="font-size: 14px;"
                                        onchange="mostrarCampoOtrosintu1()">
                                        <option value="Seleccione">Seleccione</option>
                                ...
                                <div class="col-md-3" id="intubacion_otros" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="intub_otros_1" name="intub_otros_1" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="com_intubacion2">
                                    <span style="font-size: 14px;">Complicaciones</span>
                                    <select name="complicacion_intubacion_2" id="complicacion_intubacion_2"
                                        class="form-control" style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="si">Si</option>
                                        <option value="no">No</option>
                                ...
                                <div class="col-md-3" id="tipocomplicacion_intubacion22">
                                    ...
                                    <select name="tipocomplicacion_intubacion2" id="tipocomplicacion_intubacion2"
                                        class="form-control" style="font-size: 14px;"
                                        onchange="mostrarCampoOtrosintu2()">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Broncoaspiración">Broncoaspiración</option>
                                        <option value="Ruptura de Tráquea">Ruptura de Tráquea</option>
                                        <option value="Traumatismo Dental">Traumatismo Dental</option>
                                ...
                                <div class="col-md-3" id="intubacion_otros2" name="intubacion_otros2"
                                    style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="intub_otros_2" name="intub_otros_2" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="complicaciones_intubacion3">
                                    <span style="font-size: 14px;">Complicaciones</span>
                                    <select name="complicacion_intubacion_3" id="complicacion_intubacion_3"
                                        class="form-control" style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="si">Si</option>
                                        <option value="no">No</option>
                                ...
                                <div class="col-md-3" id="tipocomplicacion_intubacion33">
                                    ...
                                    <select name="tipocomplicacion_intubacion3" id="tipocomplicacion_intubacion3"
                                        class="form-control" style="font-size: 14px;"
                                        onchange="mostrarCampoOtrosintu3()">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Broncoaspiración">Broncoaspiración</option>
                                        <option value="Ruptura de Tráquea">Ruptura de Tráquea</option>
                                        <option value="Traumatismo Dental">Traumatismo Dental</option>
                                ...
                                <div class="col-md-3" id="intubacion_otros3" name="intubacion_otros3"
                                    style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="intub_otros_3" name="intub_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="intento_cvc1">
                                    ...
                                    <select name="sitio_anatomico_1" id="sitio_anatomico_1" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <!-- Estas líneas definen las opciones dentro del menú desplegable de Intentos. -->
                                ...
                                <div class="col-md-3" id="otros_cvc1" name="otros_cvc1" style="display: none;">
                                    <!-- Estas líneas se se el campo Otros. -->
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="cvc_otros_1" name="cvc_otros_1" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div> <!-- div del row -->
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otros_cvc2" name="otros_cvc2" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="cvc_otros_2" name="cvc_otros_2" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div> <!-- div del row2 -->
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otros_cvc3" name="otros_cvc3" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="cvc_otros_3" name="cvc_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="num_parecentesis1" style="display: none;">
                            ...
                            <select name="conteo_parecentesis" id="num_parecentesis" class="form-control"
                                style="font-size: 14px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="intento_paracentesis1">
                                    <span style="font-size: 14px;">Intento</span>
                                    <select name="intento_paracentesis_1" id="intento_paracentesis_1"
                                        class="form-control" style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Exitoso">Exitoso</option>
                                        <option value="Fallido">Fallido</option>
                                ...
                                <div class="col-md-3" id="tipocomplicacion_paracentesis1" style="display: none;">
                                    ...
                                    <select name="tipocomplicacion_paracentesis_1" id="tipocomplicacion_paracentesis_1"
                                        class="form-control" style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Hematoma de la Pared Abdominal">Hematoma de la Pared Abdominal
                                        </option>
                                ...
                                <div class="col-md-3" id="otros_paracentesis_1" name="otros_paracentesis_1"
                                    style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="paracen_otros_1" name="paracen_otros_1" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="intento_paracentesis2">
                                    <span style="font-size: 14px;">Intento</span>
                                    <select name="intento_paracentesis_2" id="intento_paracentesis_2"
                                        class="form-control" style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Exitoso">Exitoso</option>
                                        <option value="Fallido">Fallido</option>
                                ...
                                <div class="col-md-3" id="otros_paracentesis_2" name="otros_paracentesis_2"
                                    style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="paracen_otros_2" name="paracen_otros_2" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                <div class="col-md-3" id="intento_paracentesis2">
                                    <span style="font-size: 14px;">Intento</span>
                                    <select name="intento_paracentesis_3" id="intento_paracentesis_3"
                                        class="form-control" style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Exitoso">Exitoso</option>
                                        <option value="Fallido">Fallido</option>
                                ...
                                <div class="col-md-3" id="otros_paracentesis_3" name="otros_paracentesis_3"
                                    style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="paracen_otros_3" name="paracen_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="num_biopsia" style="display: none;">
                            ...
                            <select name="conteo_biopsiapiel" id="num_biopsiapiel" class="form-control"
                                style="font-size: 14px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="intento_biopsiapiel1">
                                    <span style="font-size: 14px;">Intento</span>
                                    <select name="intento_biopsiapiel_1" id="intento_pbiopsiapiel_1"
                                        class="form-control" style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Exitoso">Exitoso</option>
                                        <option value="Fallido">Fallido</option>
                                ...
                                <div class="col-md-3" id="otro_biopsiapiel" name="otros_biopsiapiel"
                                    style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="biopiel_otros_1" name="biopiel_otros_1" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="intento_biopsiapiel2">
                                    <span style="font-size: 14px;">Intento</span>
                                    <select name="intento_biopsiapiel_2" id="intento_pbiopsiapiel_2"
                                        class="form-control" style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Exitoso">Exitoso</option>
                                        <option value="Fallido">Fallido</option>
                                ...
                                <div class="col-md-3" id="otro_biopsiapiel2" name="otros_biopsiapiel2"
                                    style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="biopiel_otros_2" name="biopiel_otros_2" type="text" class="form-control"
                                        name="otros_biopsiapie2" style="font-size: 13px;">
                                </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                <div class="col-md-3" id="intento_biopsiapiel3">
                                    <span style="font-size: 14px;">Intento</span>
                                    <select name="intento_biopsiapiel_3" id="intento_pbiopsiapiel_3"
                                        class="form-control" style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Exitoso">Exitoso</option>
                                        <option value="Fallido">Fallido</option>
                                ...
                                <div class="col-md-3" id="otro_biopsiapiel3" name="otros_biopsiapiel3"
                                    style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="biopiel_otros_3" name="biopiel_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="p_biposia_tejido">
                            ...
                            <select name="biposia_tejido" id="biposia_tejido" class="form-control"
                                style="font-size: 14px;">
                                <option value="Sin registro">Sin registro</option>
                                <option value="Si">Sí</option>
                                <option value="No">No</option>
                        ...
                        <div class="col-md-6" id="num_biopsiatejido" style="display: none;">
                            <strong style="font-size: 14px;">Biopsia Tejido Celular SUBC </strong>
                            <select name="conteo_biopsiaSUBC" id="num_biopsiaSUBC" class="form-control"
                                style="font-size: 14px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="tipocomplicacion_SUBC_1" style="display: none;">
                                    <span style="font-size: 14px;">Tipo de Complicaciones</span>
                                    <select name="tp_SUBC_1" id="tp_SUBC_1" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Sangrado">Sangrado</option>
                                        <option value="Infección">Infección</option>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="tipocomplicacion_SUBC_2" style="display: none;">
                                    <span style="font-size: 14px;">Tipo de Complicaciones</span>
                                    <select name="tp_SUBC_2" id="tp_SUBC_2" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Sangrado">Sangrado</option>
                                        <option value="Infección">Infección</option>
                                ...
                                <div class="col-md-3" id="otro_SUBC_2" name="otros_SUBC_2" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="subc_otros_2" name="subc_otros_2" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="tipocomplicacion_SUBC_3" style="display: none;">
                                    <span style="font-size: 14px;">Tipo de Complicaciones</span>
                                    <select name="tp_SUBC_3" id="tp_SUBC_3" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Sangrado">Sangrado</option>
                                        <option value="Infección">Infección</option>
                                ...
                                <div class="col-md-3" id="otro_SUBC_3" name="otros_SUBC_3" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="subc_otros_3" name="subc_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="p_biposia_tiroides">
                            ...
                            <select name="biposia_tiroides" id="biposia_tiroides" class="form-control"
                                style="font-size: 14px;">
                                <option value="Sin registro">Sin registro</option>
                                <option value="Si">Sí</option>
                                <option value="No">No</option>
                        ...
                        <div class="col-md-6" id="num_biopsiat">
                            ...
                            <select name="conteo_biopsiatiroides" id="num_biopsiatiroides" class="form-control"
                                style="font-size: 14px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otro_BT_1" name="otros_BT_1" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="bt_otros_1" name="bt_otros_1" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otro_BT_2" name="otros_BT_2" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="bt_otros_2" name="bt_otros_2" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otro_BT_3" name="otros_BT_3" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="bt_otros_3" name="bt_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="p_toracocentesis">
                            ...
                            <select name="toracocentesis" id="toracocentesis" class="form-control"
                                style="font-size: 14px;">
                                <option value="Sin registro">Sin registro</option>
                                <option value="Si">Sí</option>
                                <option value="No">No</option>
                        ...
                        <div class="col-md-6" id="num_tora">
                            <strong style="font-size: 14px;">Toracocentesis </strong>
                            <select name="conteo_toracocentesis" id="num_toracocentesis" class="form-control"
                                style="font-size: 14px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otro_tora_1" name="otros_tora_1" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="tora_otros_1" name="tora_otros_1" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otro_tora_2" name="otros_tora_2" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="tora_otros_2" name="tora_otros_2" type="text" class="form-control"
                                        id="otro_tora_2" name="otros_tora_2" style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        <!-- *********************************** Toracocentesis  3 ********************************** -->
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otro_tora_3" name="otros_tora_3" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="tora_otros_3" name="tora_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="p_artrocentesis">
                            ...
                            <select name="artrocentesis" id="artrocentesis" class="form-control"
                                style="font-size: 14px;">
                                <option value="Sin registro">Sin registro</option>
                                <option value="Si">Sí</option>
                                <option value="No">No</option>
                        ...
                        <div class="col-md-6" id="num_artrocentesis1" style="display: none;">
                            <strong style="font-size: 14px;">Artrocentesis</strong>
                            <select name="conteo_artrocentesis" id="num_artrocentesis" class="form-control"
                                style="font-size: 14px;">
                                <option value="Seleccione">Seleccione</option>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="tipocomplicacion_Artro_1">
                                    <span style="font-size: 14px;">Tipo de Complicaciones</span>
                                    <select name="tp_Artro_1" id="tp_Artro_1" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                ...
                                <div class="col-md-3" id="otro_Artro_1" name="otros_Artro_1" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="artro_otros_1" name="artro_otros_1" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="tipocomplicacion_Artro_2">
                                    <span style="font-size: 14px;">Tipo de Complicaciones</span>
                                    <select name="tp_Artro_2" id="tp_Artro_2" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Artritis Séptica">Artritis Séptica </option>
                                        <option value="Bursitis Séptica">Bursitis Séptica</option>
                                ...
                                <div class="col-md-3" id="otro_Artro_2" name="otros_Artro_2" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="artro_otros_2" name="artro_otros_2" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="tipocomplicacion_Artro_3">
                                    <span style="font-size: 14px;">Tipo de Complicaciones</span>
                                    <select name="tp_Artro_3" id="tp_Artro_3" class="form-control"
                                        style="font-size: 14px;">
                                        <option value="Seleccione">Seleccione</option>
                                        <option value="Artritis Séptica">Artritis Séptica </option>
                                        <option value="Bursitis Séptica">Bursitis Séptica</option>
                                ...
                                <div class="col-md-3" id="otro_Artro_3" name="otros_Artro_3" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="artro_otros_3" name="artro_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="p_aspiracion_mo">
                            ...
                            <select name="aspiracion_mo" id="aspiracion_mo" class="form-control"
                                style="font-size: 14px;">
                                <option value="Sin registro">Sin registro</option>
                                <option value="Si">Sí</option>
                                <option value="No">No</option>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otro_MO_1" name="otros_MO_1" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="mo_otros_1" name="mo_otros_1" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otro_MO_2" name="otros_MO_2" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="mo_otros_2" name="mo_otros_2" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        font-size: 13px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="otro_MO_3" name="otros_MO_3" style="display: none;">
                                    <span style="font-size: 14px;">Otros</span>
                                    <input id="mo_otros_3" name="mo_otros_3" type="text" class="form-control"
                                        style="font-size: 13px;">
                                </div>
                            </div>
                        </div>
