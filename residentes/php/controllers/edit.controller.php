<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        $query= "SELECT dp.*,p.*, a.*, b.*, c.*, d.*, e.*, f.*, g.*, h.*, i.*, j.*
        ...
        LEFT JOIN procedimientos p ON dp.id_productividad = p.id_productividad WHERE dp.id_productividad ='$id_residente'";
        ...
        if (!empty($AllData)) {
            foreach ($AllData as $data) {
                ...
                $parasentesis     = $data['parasentesis'];
                ...
                $biopsia_piel     = $data['biopsia_piel'];
                ...
                $biopsia_celular  = $data['biopsia_celular'];
                ...
                $biopsia_tiroides = $data['biopsia_tiroides'];
                ...
                $toracosentesis   = $data['toracosentesis'];
                ...
                $artrocentesis    = $data['artrocentesis'];
