...
const curpInput = document.getElementById('curp_seg');

curpInput.addEventListener('blur', function() {
this.value = this.value.toUpperCase();
});

const nombreInput = document.getElementById('nombre_paciente_seg');
...
var curp = document.getElementById("curp_seg").value;
...
document.getElementById("fecha_seg").value = fechaCompleta;
...
document.getElementById("edad_seg").value = edad;

// Determinar el sexo y mostrarlo en el campo correspondiente

var sexo = curp.charAt(10);
if (sexo === "H") {
document.getElementById("sexo_seg").value = "Hombre";
} else if (sexo === "M") {
document.getElementById("sexo_seg").value = "Mujer";
}
}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var fechaRegistroInput = document.getElementById("fecha_registro_seg");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var selectTipoConsulta = document.getElementById("tipo_consulta_seg");
    var divNumSesiones = document.getElementById("num_sesiones_seg");
