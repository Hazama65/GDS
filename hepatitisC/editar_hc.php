            ...
            <div class="row">
                <input type="hidden" id="id_paciente" name="id_paciente" value="<?php echo $id_paciente; ?>">
                        ...
                        <div class="col-md-4" id="idcurp">
                            ...
                            <input type="text" class="form-control" id="curp" name="curp" placeholder="CURP..." style="font-size: 14px;" required value="<?php echo $curp; ?>">
                        </div>

                        <div class="col-md-4" id="idnombre">
                            <strong style="font-size: 14px;">Nombre Completo</strong>
                            <input id="nombre" name="nombre" onblur="calcularEdad();" type="text" class="control form-control" placeholder="Nombre(s) Apellidos" style="font-size: 14px;" required value="<?php echo $nombre; ?>">
                        </div>

                        <div class="col-md-4">
                            <strong style="font-size: 14px;">Fecha Nacimiento</strong>
                            <input id="fecha" name="fecha" type="date" onblur="curp2date();" class="control form-control" style="font-size: 14px;" readonly value="<?php echo $fecha_nacimiento; ?>">
                        </div>
...
<!-- hice cambios aqui -->
        ...
        <!--*************************************************************************************************+-->
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" id="fai" name="fai" class="form-control" style="font-size: 14px;" max="<?= date("Y-m-d") ?>"  value="<?php echo $atencion_inicial; ?>">
                    </div>

                    <div class="col-md-4">
                        <strong style="font-size: 14px;">Carga Viral Inicial</strong>
                        <input type="date" id="fcvi" name="fcvi" class="form-control" style="font-size: 14px;" max="<?= date("Y-m-d") ?>"  value="<?php echo $carga_inicial; ?>">
                    </div>

                    <div class="col-md-4">
                        <strong style="font-size: 14px;">Carga Viral Dx</strong>
                        <input type="number" step="any" class="form-control" id="cvd" name="cvd" style="font-size: 14px;"  value="<?php echo $cargaDX; ?>">
                    </div>

                    <div class="col-md-12">
                        <strong style="font-size: 14px;">Respuesta Viral Sostenida (RVS)</strong>
                        <select name="respuestaviralsostenida" id="respuestaviralsostenida" class="form-control" style="font-size: 14px;">
                    ...
                    <div class="col-md-6" id="idvalorrvs" >
                        ...
                        <input type="number" step="any" class="form-control" id="valorrvs" style="font-size: 14px;" name="valorrvs"  value="<?php echo $RVS; ?>">
                    </div>

                    <div class="col-md-6" id="idfrvs" >
                        <strong style="font-size: 14px;">Fecha RVS</strong>
                        <input type="date" id="frvs" name="frvs" class="form-control" style="font-size: 14px;" max="<?= date("Y-m-d") ?>"  value="<?php echo $fechaRVS; ?>">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <input type="number" step="any" class="form-control" id="AST" name="AST" style="font-size: 14px;" required  value="<?php echo $AST; ?>">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;">BUN</strong>
                            <input type="number" step="any" class="form-control" id="BUN" name="BUN" style="font-size: 14px;" required  value="<?php echo $BUN; ?>">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;">CREAT</strong>
                            <input type="number" step="any" class="form-control" id="CREAT" name="CREAT" style="font-size: 14px;" required  value="<?php echo $CREAT; ?>">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;" >ALT</strong>
                            <input type="number" step="any" class="form-control" id="ALT" name="ALT" style="font-size: 14px;" required  value="<?php echo $ALT; ?>">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;">Plaquetas</strong>
                            <input type="number" step="any" class="form-control" id="Plaquetas" name="Plaquetas" style="font-size: 14px;" required  value="<?php echo $plaquetas; ?>">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;">Albumina</strong>
                            <input type="number" step="any" class="form-control" id="Albumina" name="Albumina" style="font-size: 14px;" required  value="<?php echo $albumina; ?>">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;">Glucosa</strong>
                            <input type="number" step="any" class="form-control" id="Glucosa" name="Glucosa" style="font-size: 14px;" required  value="<?php echo $glucosa; ?>">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;">HBA1C</strong>
                            <input type="number" step="any" class="form-control" id="HBA1C" name="HBA1C" style="font-size: 14px;" required  value="<?php echo $HBA1C; ?>">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;">Trigliceridos</strong>
                            <input type="number" step="any" class="form-control" id="Trigliceridos" name="Trigliceridos" style="font-size: 14px;" required  value="<?php echo $trigliceridos; ?>">
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;">HDL</strong>
                            <input type="number" step="any" class="form-control" id="HDL" name="HDL" style="font-size: 14px;" required  value="<?php echo $HDL; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="ultrasonidohepatico" id="ultrasonidohepatico" class="form-control" style="font-size: 14px;" >
                    ...
                    <div class="col-md-12" id="idresultadoultrasonido" >
                        ...
                        <select name="resultadoultrasonido" id="resultadoultrasonido" class="form-control" style="font-size: 14px;" >
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" step="any" class="form-control" id="fib4" name="fib4" style="font-size: 14px;" value="<?php echo $FIB4; ?>">
                    </div>
                    <div class="col-md-4">
                        <strong id="calcularresultado" style="font-size: 14px;">Resultado FIB 4</strong>
                        <input type="text" class="form-control" id="resultadofib" name="resultadofib" style="font-size: 14px;" readonly value="<?php echo $FIB4resultado; ?>">
                    </div>


                    <div class="col-md-2">
                        <a style="font-size: 14px;" href="https://www.rccc.eu/calculadoras/NFS.html" target="_blank">NAFLD</a>
                        <input type="number" step="any" class="form-control" id="nafld" name="nafld" style="font-size: 14px;" value="<?php echo $NAFLD; ?>">
                    </div>
                    <div class="col-md-4">
                        <strong id="calcularresultado" style="font-size: 14px;">Resultado NAFLD</strong>
                        <input type="text" class="form-control" id="resultadonafld" name="resultadonafld" style="font-size: 14px;" readonly value="<?php echo $NAFLDresultado; ?>">
                    </div>

                    <div class="col-md-2">
                        <a style="font-size: 14px;" href="https://www.hepatitisc.uw.edu/page/clinical-calculators/apri" target="_blank">APRI</a>
                        <input type="number" step="any" class="form-control" id="apri" name="apri" style="font-size: 14px;" value="<?php echo $APRI; ?>">
                    </div>
                    <div class="col-md-4">
                        <strong id="calcularresultado" style="font-size: 14px;">Resultado APRI</strong>
                        <input type="text" class="form-control" id="resultadoapri" name="resultadoapri" style="font-size: 14px;" readonly value="<?php echo $APRIresultado; ?>">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="date" id="fit" name="fit" style="font-size: 14px;" class="form-control" value="<?php echo $fecha_inicio; ?>">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" id="fft" name="fft" style="font-size: 14px;" class="form-control" value="<?php echo $fecha_fin; ?>">
                        </div>
                    ...
                    <br><div class="container" style="text-align: right;">
