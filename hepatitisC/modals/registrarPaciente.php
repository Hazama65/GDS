                ...
                <form id="hepatitis_form" method="POST" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" id="idnombre">
                            ...
                            <input id="nombre" name="nombre" onblur="calcularEdad();" type="text"
                                class="control form-control" value="" placeholder="Nombre(s) Apellidos"
                                style="font-size: 14px;" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="fecha" name="fecha" type="date" value="" onblur="curp2date();"
                                class="control form-control" style="font-size: 14px;" readonly>
                        </div>


                        <div class="col-md-4">
                            <strong style="font-size: 14px;">Edad</strong>
                            <input id="edad" name="edad" type="text" class="control form-control" value=""
                        ...
                        <div class="col-md-4" id="unidad_referencia_div" style="display: none;">
                            ...
                            <input list="Clues" type="text" name="unidad_referencia" id="unidad_referencia"
                                class="form-control">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="any" class="form-control" id="peso" onblur="calculaIMC();"
                                name="peso" required>
                        </div>

                        <div class="col-md-2">
                            <strong style="font-size: 14px;">IMC</strong>
                            <input type="text" class="form-control" id="imc" onblur="calculaIMC();" name="imc" value=""
                                readonly>
                        </div>

                        <div class="col-md-3">
                            <strong style="font-size: 14px;">Resultado IMC</strong>
                            <input type="text" class="form-control" id="imcdescripcion" name="imcdescripcion" value=""
                                readonly>
                        </div>

                        <div class="col-md-3">
                            <strong style="font-size: 14px;">Circunferencia</strong>
                            <input type="number" step="any" class="form-control" id="circunferencia"
                    ...
                    <div class="col-md-12" style="font-size: 14px;">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="FR_Sin_Registro" name="FR_Sin_Registro"
                                value="Sin Registro">
                            <label class="form-check-label" for="FR_Sin_Registro" style="font-size: 14px;">Sin
                                registro</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="FR_Relaciones_Sexuales"
                                name="FR_Relaciones_Sexuales" value="Relaciones Sexuales"
                                onchange="showRelacionesSexualesDiv(this)">
                            <label class="form-check-label" for="FR_Relaciones_Sexuales"
                                style="font-size: 14px;">Relaciones Sexuales</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="FR_Transfusiones"
                                name="FR_Transfusiones" value="Transfusiones">
                            <label class="form-check-label" for="FR_Transfusiones"
                                style="font-size: 14px;">Transfusiones</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="FR_Drogas_Endovenosas"
                                name="FR_Drogas_Endovenosas" value="Drogas Endovenosas">
                            <label class="form-check-label" for="FR_Drogas_Endovenosas" style="font-size: 14px;">Drogas
                                Endovenosas</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="FR_Piercing" name="FR_Piercing"
                                value="Piercing">
                            <label class="form-check-label" for="FR_Piercing" style="font-size: 14px;">Piercing</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="FR_Presidiario" name="FR_Presidiario"
                                value="Presidiario">
                            <label class="form-check-label" for="FR_Presidiario"
                                style="font-size: 14px;">Presidiario</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="FR_Expresidiario"
                                name="FR_Expresidiario" value="Expresidiario">
                            <label class="form-check-label" for="FR_Expresidiario"
                                style="font-size: 14px;">Expresidiario</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="FR_Situacion_de_Calle"
                                name="FR_Situacion_de_Calle" value="Situación de Calle">
                            <label class="form-check-label" for="FR_Situacion_de_Calle"
                                style="font-size: 14px;">Situación de Calle</label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12" id="idrelacionessexuales" style="display: none;">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="RS_Ninguna" name="RS_Ninguna"
                                value="Ninguna">
                            <label class="form-check-label" for="RS_Ninguna" style="font-size: 14px;">Ninguna de las
                                anteriores</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="RS_Pacientes_con_VIH"
                                name="RS_Pacientes_con_VIH" value="Pacientes con VIH">
                            <label class="form-check-label" for="RS_Pacientes con VIH"
                                style="font-size: 14px;">Pacientes con VIH</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="RS_Pacientes_con_Hepatitis"
                                name="RS_Pacientes_con_Hepatitis" value="Pacientes con Hepatitis">
                            <label class="form-check-label" for="RS_Pacientes con Hepatitis"
                                style="font-size: 14px;">Pacientes con Hepatitis</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="RS_Sexo_Servidoras"
                                name="RS_Sexo_Servidoras" value="Sexo Servidoras">
                            <label class="form-check-label" for="RS_Sexo Servidoras" style="font-size: 14px;">Sexo
                                Servidoras</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="RS_Parejas_Ocasionales"
                                name="RS_Parejas_Ocasionales" value="Parejas Ocasionales">
                            <label class="form-check-label" for="RS_Parejas Ocasionales"
                                style="font-size: 14px;">Parejas Ocasionales</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="RS_Pacientes_con_Toxicomanias"
                                name="RS_Pacientes_con_Toxicomanias" value="Pacientes con Toxicomanias">
                            <label class="form-check-label" for="RS_Pacientes con Toxicomanias"
                                style="font-size: 14px;">Pacientes con Toxicomanias</label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12" style="font-size: 14px;">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Hemofilia" name="APP_Hemofilia"
                                value="Hemofilia">
                            <label class="form-check-label" for="APP_Hemofilia">Hemofilia</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_ERC_en_Hemodialisis"
                                name="APP_ERC_en_Hemodialisis" value="ERC en Hemodialisis">
                            <label class="form-check-label" for="APP_ERC_en_Hemodialisis">ERC en Hemodialisis</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Trabajador_de_la_Salud"
                                name="APP_Trabajador_de_la_Salud" value="Trabajador de la Salud">
                            <label class="form-check-label" for="APP_Trabajador_de_la_Salud">Trabajador de la
                                Salud</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Transplante" name="APP_Transplante"
                                value="Transplante">
                            <label class="form-check-label" for="APP_Transplante">Transplante</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Cirrosis" name="APP_Cirrosis"
                                value="Cirrosis">
                            <label class="form-check-label" for="APP_Cirrosis">Cirrosis</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Obesidad" name="APP_Obesidad"
                                value="Obesidad">
                            <label class="form-check-label" for="APP_Obesidad">Obesidad</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Prediabetes" name="APP_Prediabetes"
                                value="Prediabetes">
                            <label class="form-check-label" for="APP_Prediabetes">Prediabetes</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Diabetes_Mellitus"
                                name="APP_Diabetes_Mellitus" value="Diabetes Mellitus">
                            <label class="form-check-label" for="APP_Diabetes_Mellitus">Diabetes Mellitus</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Hipertension_Arterial"
                                name="APP_Hipertension_Arterial" value="Hipertensión Arterial">
                            <label class="form-check-label" for="APP_Hipertension_Arterial">Hipertensión
                                Arterial</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Alcoholismo" name="APP_Alcoholismo"
                                value="Alcoholismo">
                            <label class="form-check-label" for="APP_Alcoholismo">Alcoholismo</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Virus_HB" name="APP_Virus_HB"
                                value="Virus HB">
                            <label class="form-check-label" for="APP_Virus_HB">Virus HB</label>
                        </div>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="APP_Ninguno" name="APP_Ninguno"
                                value="Ninguno">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="date" id="fai" name="fai" class="form-control" style="font-size: 14px;"
                                max="<?= date("Y-m-d") ?>">
                        </div>

                        <div class="col-md-4">
                            <strong style="font-size: 14px;">Carga Viral Inicial</strong>
                            <input type="date" id="fcvi" name="fcvi" class="form-control" style="font-size: 14px;"
                                max="<?= date("Y-m-d") ?>">
                        </div>

                        <div class="col-md-4">
                            <strong style="font-size: 14px;">Carga Viral Dx</strong>
                            <input type="number" step="any" class="form-control" id="cvd" name="cvd"
                                style="font-size: 14px;">
                        </div>

                        <div class="col-md-12">
                            <strong style="font-size: 14px;">Respuesta Viral Sostenida (RVS)</strong>
                            <select name="respuestaviralsostenida" id="respuestaviralsostenida" class="form-control"
                                style="font-size: 14px;" onchange="showRVSOptions(this)">
                        ...
                        <div class="col-md-6" id="idvalorrvs" style="display: none;">
                            ...
                            <input type="number" step="any" class="form-control" id="valorrvs" style="font-size: 14px;"
                                name="valorrvs">
                        </div>

                        <div class="col-md-6" id="idfrvs" style="display: none;">
                            <strong style="font-size: 14px;">Fecha RVS</strong>
                            <input type="date" id="frvs" name="frvs" class="form-control" style="font-size: 14px;"
                                max="<?= date("Y-m-d") ?>">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <input type="number" step="any" class="form-control" id="AST" name="AST"
                                style="font-size: 14px;" required>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="any" class="form-control" id="CREAT" name="CREAT"
                                style="font-size: 14px;" required>
                        </div>
                        <div class="col-md-2">
                            <strong style="font-size: 14px;">ALT</strong>
                            <input type="number" step="any" class="form-control" id="ALT" name="ALT"
                                style="font-size: 14px;" required>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="any" class="form-control" id="HBA1C" name="HBA1C"
                                style="font-size: 14px;" required>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="any" class="form-control" id="HDL" name="HDL"
                                style="font-size: 14px;" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="ultrasonidohepatico" id="ultrasonidohepatico" class="form-control"
                            style="font-size: 14px;" onchange="showUHOptions(this)">
                            <option value="Sin registro">Sin registro</option>
                            <option value="Si">Sí</option>
                            <option value="No">No</option>
                    ...
                    <div class="col-md-12" id="idresultadoultrasonido" style="display: none;">
                        ...
                        <select name="resultadoultrasonido" id="resultadoultrasonido" class="form-control"
                            style="font-size: 14px;" onchange="showEsteatosisOptions(this)">
                            <option value="Seleccione">Seleccione...</option>
                    ...
                    <div class="col-md-12" id="idesteatosis" style="display: none;">
                        ...
                        <select name="opcionesteatosis" id="opcionesteatosis" style="font-size: 14px;"
                            class="form-control">
                            <option value="Seleccione">Seleccione...</option>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <a style="font-size: 14px;"
                                href="https://www.hepatitisc.uw.edu/page/clinical-calculators/fib-4" target="_blank">FIB
                                4</a>
                            <input type="number" step="any" class="form-control" id="fib4" name="fib4"
                                style="font-size: 14px;" onkeyup="calculateFIB4Result()">
                        </div>
                        <div class="col-md-4">
                            <strong id="calcularresultado" style="font-size: 14px;">Resultado FIB 4</strong>
                            <input type="text" class="form-control" id="resultadofib" value="" name="resultadofib"
                                style="font-size: 14px;" readonly>
                        </div>


                        <div class="col-md-2">
                            <a style="font-size: 14px;" href="https://www.rccc.eu/calculadoras/NFS.html"
                                target="_blank">NAFLD</a>
                            <input type="number" step="any" class="form-control" id="nafld" name="nafld"
                                style="font-size: 14px;" onkeyup="calculateNAFLDResult()">
                        </div>
                        <div class="col-md-4">
                            <strong id="calcularresultado" style="font-size: 14px;">Resultado NAFLD</strong>
                            <input type="text" class="form-control" id="resultadonafld" value="" name="resultadonafld"
                                style="font-size: 14px;" readonly>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="any" class="form-control" id="apri" name="apri"
                                style="font-size: 14px;" onkeyup="calculateAPRIResult()">
                        </div>
                        <div class="col-md-4">
                            <strong id="calcularresultado" style="font-size: 14px;">Resultado APRI</strong>
                            <input type="text" class="form-control" id="resultadoapri" value="" name="resultadoapri"
                                style="font-size: 14px;" readonly>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="defuncion" id="defuncion" class="form-control" style="font-size: 14px;"
                            onchange="showDefuncionOptions(this)">
                            <option value="Sin registro">Sin registro</option>
                            <option value="Si">Sí</option>
                            <option value="No">No</option>
                            <option value="Desconoce">Desconoce</option>
